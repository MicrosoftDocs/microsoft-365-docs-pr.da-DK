...
Du skal oprette en udtrækningsenhed for hver enhed i det dokument, du vil udtrække. I vores eksempel vil vi udtrække  **startdatoen for tjenester**  for hvert  **Kontraktfornyelsesdokument** , der er identificeret af modellen. Vi vil gerne have vist en visning i dokumentbiblioteket for  **alleKontraktfornyelsesdokumenter**  med en kolonne, der viser værdien for **tjenestens** startdato for hvert dokument. 
