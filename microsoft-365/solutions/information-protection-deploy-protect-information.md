...
- zerotrust-solution
ms.custom: ''
description: Udrul funktioner til sikkerhed og overholdelse af angivne standarder i Microsoft 365, og beskyt dine personlige oplysninger.
ms.openlocfilehash: ca2f500c5a6f09bf051137de2b637feb5a00f391
ms.sourcegitcommit: 61b22df76e0f81e5ef11c587b129287886151c79
ms.translationtype: MT
ms.contentlocale: da-DK
ms.lasthandoff: 07/12/2022
ms.locfileid: "66750270"
---
...
- Adgangskontrolelementer for Teams og websteder
...
> [!NOTE]
> Denne løsning beskriver sikkerheds- og overholdelsesfunktioner for at beskytte oplysninger, der er underlagt regler om beskyttelse af personlige oplysninger. Du kan se en komplet liste over sikkerhedsfunktioner i Microsoft 365 i [sikkerhedsdokumentationen til Microsoft 365](../security/index.yml). Du kan se en komplet liste over funktioner til overholdelse af angivne standarder i Microsoft 365 i [dokumentationen til Microsoft Purview](../compliance/index.yml).
...
Du kan få oplysninger om andre funktioner til beskyttelse af oplysninger uden for Microsoft 365 under:
...
Følsomhedsmærkater fra Microsoft Purview Information Protection giver dig mulighed for at klassificere og beskytte organisationens data uden at hindre brugernes produktivitet og deres mulighed for at samarbejde.
...
1. Forstå følgende:
   ...
   - **Vigtige ting at huske** Følsomhedsmærkater administreres i Microsoft Purview-compliance-portal, men indstillingerne for målretning og program varierer betydeligt.
      ...
      - Der er følsomhedsmærkater for aktivt indhold. Disse publiceres også til brugere eller grupper, som enten anvender dem manuelt, eller som anvendes automatisk, når:
        ...
        - Der sendes en mail.
      - Der er følsomhedsmærkater for automatisk program til inaktive filer i SharePoint og OneDrive ud over mails under overførsel via Exchange. Disse er målrettet til enten alle websteder eller specifikke websteder og gælder automatisk for inaktive filer i disse miljøer.
...
Når du opretter [følsomhedsmærkater](../compliance/sensitivity-labels-teams-groups-sites.md) i <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Microsoft Purview-compliance-portal</a>, kan du nu anvende dem på disse objektbeholdere:
...
Når du publicerer følsomhedsmærkater fra <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Microsoft Purview-compliance-portal</a>, vises de i [Office-apps](../compliance/sensitivity-labels-office-apps.md), så brugerne kan klassificere og beskytte indhold, når det oprettes eller redigeres.
...
Du kan bruge [DLP (forebyggelse af datatab)](../compliance/dlp-learn-about-dlp.md) i Microsoft 365 til at registrere, advare og blokere risikable, utilsigtede eller upassende deling, f.eks. deling af data, der indeholder personlige oplysninger, både internt og eksternt.
...
Med en DLP-politik i <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Microsoft Purview-compliance-portal</a> kan du identificere, overvåge og automatisk beskytte følsomme elementer på tværs af mange placeringer i Microsoft 365, f.eks. Exchange Online, SharePoint, OneDrive og Microsoft Teams.

Du kan f.eks. identificere et hvilket som helst dokument, der indeholder et kreditkortnummer, som er gemt på et hvilket som helst OneDrive-websted, eller du kan kun overvåge OneDrive-webstederne for bestemte personer.
...
DLP-politikker konfigureres i Microsoft Purview-compliance-portal og angiver beskyttelsesniveauet, den følsomme informationstype, som politikken leder efter, og målarbejdsbelastningerne. Deres grundlæggende komponenter består i at identificere beskyttelsen og typerne af data.
...
| C |  Følsomhedsmærkat med indstillingen "Ejeren kan ikke invitere gæster" er publiceret til bruger A, der klargør et Teams-team eller SharePoint-websted. En anden bruger af webstedet forsøger selektivt at dele en fil med Bruger B, men DLP blokerer den. |
...
I forbindelse med beskyttelse af personlige oplysninger skal du bruge OME til at beskytte interne meddelelser, der indeholder følsomme elementer. Office 365 Message Encryption er en onlinetjeneste, der er baseret på Microsoft Azure Rights Management (Azure RMS), som er en del af Azure Information Protection. Dette omfatter politikker for kryptering, identitet og godkendelse for at hjælpe med at beskytte din mail. Du kan kryptere meddelelser ved hjælp af rettighedsadministrationsskabeloner, indstillingen Videresend ikke og indstillingen Kun kryptering.
...
| Automatisk mærkning <br> Organisationen ønsker automatisk at beskytte mails/vedhæftede filer med bestemt følsomt indhold og/eller bestemte modtagere | Anbefal (E5) – Automatisk mærkning i Exchange- og Outlook-klienter, øger regler for mailflow og DLP-politik | Ja – regler for mailflow og DLP-politik med beskyttelse af kryptering eller Videresend ikke |
||||
...
For organisationer, der planlægger at gemme personlige data, der er omfattet af regler for beskyttelse af personlige oplysninger i Teams, skal du se [Konfigurer et team med sikkerhedsisolation](secure-teams-security-isolation.md), som indeholder detaljeret vejledning og konfigurationstrin til:
