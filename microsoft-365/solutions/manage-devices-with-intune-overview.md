...
audience: ITPro
ms.topic: article
description: Tilmeld dine slutpunktsenheder i Microsoft Intune som en del af din Zero Trust-sikkerhedsarkitektur, der beskytter mod ransomware, mens du bygger beskyttelse til fjernarbejdere.
...
ms.locfileid: "65923362"
---
# <a name="manage-devices-with-intune-overview"></a>Administrer enheder med Intune-oversigt

En kernekomponent i sikkerhed på virksomhedsniveau omfatter administration og beskyttelse af enheder. Uanset om du bygger en Zero Trust-sikkerhedsarkitektur, hærder dit miljø mod ransomware eller bygger beskyttelse for at understøtte fjernarbejdere, er administration af enheder en del af strategien.
...
- Tillad BYOD-enheder med planer om at implementere beskyttelse af apps og data og/eller tilmelde disse enheder til Intune.

Hvis dit miljø på den anden side indeholder planer for medadministration, herunder Microsoft Endpoint Configuration Manager, skal du se [Dokumentation til samtidig administration](/mem/configmgr/comanage/) for at udvikle den bedste sti til din organisation. Hvis dit miljø indeholder planer for Windows 365 Cloud-pc, skal du se [Dokumentationen til Windows 365 Enterprise](/windows-365/enterprise/) for at udvikle den bedste sti til din organisation.
...
Den moderne virksomhed har en utrolig mangfoldighed af slutpunkter, der tilgår deres data. Denne konfiguration skaber en massiv angrebsoverflade, og slutpunkter kan derfor nemt blive det svageste led i din Zero Trust-sikkerhedsstrategi.
...
|6|Overvåg enhedsrisiko og overholdelse af sikkerhedsbaselinjer|I dette trin skal du oprette forbindelse mellem Intune og Microsoft Defender for Endpoint. Med denne integration kan du derefter overvåge enhedsrisikoen som en betingelse for adgang. Enheder, der er i risikotilstand, blokeres. Du kan også overvåge overholdelse af grundlæggende sikkerhedsgrundlinjer. Se [**trin 6. Overvåg enhedsrisici og overholdelse af angivne standarder i forhold til grundlæggende sikkerhedslinjer**](manage-devices-with-intune-monitor-risk.md).|E5, F5|
...
## <a name="coordinating-endpoint-management-with-zero-trust-identity-and-device-access-policies"></a>Koordinering af administration af slutpunkter med Zero Trust-identitet og politikker for enhedsadgang

Denne vejledning er tæt koordineret med de anbefalede [**Zero Trust-identitets- og adgangspolitikker for enheder**](../security/office-365-security/microsoft-365-policies-configurations.md). Du arbejder sammen med dit identitetsteam om at gennemføre den beskyttelse, du konfigurerer med Intune, i politikker for betinget adgang i Azure AD.
...
[![Politikker for nul tillid til identitet og enhedsadgang](../media/devices/identity-device-overview-steps.png#lightbox)](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/media/devices/identity-device-overview-steps.png)
...
Følgende illustration indeholder oplysninger om, hvordan dette fungerer ved hjælp af Intune.
...
Bemærk, at det kun er Intune, der administrerer enheder. Onboarding refererer til muligheden for, at en enhed kan dele oplysninger med en bestemt tjeneste. I følgende tabel opsummeres forskellene mellem at tilmelde enheder til administration og onboarding af enheder for en bestemt tjeneste.


| &nbsp; |Tilmelde     |Onboard  |
|---------|---------|---------|
|Beskrivelse     |  Tilmelding gælder for administration af enheder. Enheder er tilmeldt administration med Intune eller Konfigurationsstyring.        | Onboarding konfigurerer en enhed til at arbejde med et bestemt sæt funktioner i Microsoft 365. Onboarding gælder i øjeblikket for Microsoft Defender for Endpoint og Microsofts funktionalitet til overholdelse af angivne standarder. <br><br>På Windows-enheder omfatter onboarding at slå en indstilling i Windows Defender til og fra, der gør det muligt for Defender at oprette forbindelse til onlinetjenesten og acceptere politikker, der gælder for enheden.        |
...
|Anbefalet metode     | Azure Active Directory joinforbinder automatisk enheder til Intune.        | Intune er den foretrukne metode til onboarding af enheder til Windows Defender for Endpoint og derfor Microsoft Purview-funktioner.<br><br>Bemærk, at enheder, der er onboardet til Microsoft Purview-funktioner ved hjælp af andre metoder, ikke automatisk tilmeldes Defender for Endpoint.        |
