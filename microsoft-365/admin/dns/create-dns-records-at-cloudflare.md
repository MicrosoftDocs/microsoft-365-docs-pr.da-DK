...
1. I Microsoft 365 Administration skal du **Indstillinger** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank">**Domæner**</a> og vælge det domæne, du vil konfigurere.

1. Vælg de tre (flere handlinger) \> vælg **Start installationen**.
...
2. Opret enten to navneserverposter ved hjælp af værdierne i følgende tabel, eller rediger de eksisterende navneserverposter, så de matcher disse værdier.
    ...
    |Type|Værdi|
    |---|---|
    |Første navneserver|Brug den navneserverværdi, der leveres af Cloudflare.|
    |Anden navneserver|Brug den navneserverværdi, der leveres af Cloudflare.|
...
1. Vælg TXT-typen på rullelisten, og skriv eller kopiér og indsæt værdierne fra denne tabel.
    ...
    |---|---|---|:----|
    |TXT|@|30 minutter|MS=*msXXXXXXXX* <br/> **Bemærk!** Dette er et eksempel. Brug din specifikke **værdi fra Destination eller** adressehensepunkter her fra tabellen. [Hvordan gør jeg du finde dette?](../get-help-with-domains/information-for-dns-records.md)|
...
1. Vælg MX-typen på rullelisten, og skriv eller kopiér og indsæt værdierne fra denne tabel.
   ...
   |---|---|---|---|---|
   |MX|@|*\<domain-key\>*.mail.protection.outlook.com <br/> **Bemærk!** Få din *\<domain-key\>* fra din Microsoft 365 konto. [Hvordan gør jeg du finde dette?](../get-help-with-domains/information-for-dns-records.md)|30 minutter|1 <br/> Du kan finde flere oplysninger om prioritet under [Hvad er MX-prioritet?](../setup/domains-faq.yml) <br/>|
...
1. Vælg CNAME-typen på rullelisten, og skriv eller kopiér og indsæt værdierne fra denne tabel.
    ...
    |---|---|---|---|
    |CNAME|autodiscover|autodiscover.outlook.com|Automatisk|
...
1. Vælg TXT-typen på rullelisten, og skriv eller kopiér og indsæt værdierne fra denne tabel.
    ...
    |Type|Navn|TTL|Indhold|
    |---|---|---|---|
    |TXT|@|30 minutter|v=spf1 include:spf.protection.outlook.com -all <br/> **Bemærk!** Vi anbefaler, at du kopierer og indsætter denne indtastning, så alle mellemrum forbliver korrekte.|
