...
4. I felterne for den nye post skal du skrive eller kopiere og indsætte værdierne fra følgende tabel.
   ...
   |---|---|---|
   |Udfyldes automatisk (lad feltet være tomt)|MS=*msXXXXXXXX* <br/> **Bemærk!** Dette er et eksempel. Brug din specifikke **værdi fra Destination eller** adressehensepunkter her fra tabellen. [Hvordan gør jeg du finde dette?](../get-help-with-domains/information-for-dns-records.md)|1 time|
...
1. I felterne for den nye post skal du skrive eller kopiere og indsætte værdierne fra følgende tabel:
   ...
   |---|---|---|---|
   |Udfyldes automatisk|*\<domain-key\>*.mail.protection.outlook.com <br/> **Bemærk!** Få din fra *\<domain-key\>* din Microsoft-konto.  [Hvordan gør jeg du finde dette?](../get-help-with-domains/information-for-dns-records.md)|0 <br/> Du kan finde flere oplysninger om prioritet under [Hvad er MX-prioritet?](../setup/domains-faq.yml)|1 time|
...
4. I felterne for den nye post skal du skrive eller kopiere og indsætte værdierne fra følgende tabel:
   ...
   |Host Name|Værdi|TTL|
   |---|---|---|
   |[lad dette stå tomt]|v=spf1 include:spf.protection.outlook.com -all <br/> **Bemærk!** Vi anbefaler, at du kopierer og indsætter denne indtastning, så alle mellemrum forbliver korrekte.|1 time|
