---
title: Onboard tidligere versioner af Windows på Microsoft Defender for Endpoint
description: Onboard understøttede tidligere versioner Windows enheder, så de kan sende sensordata til Microsoft Defender for Endpoint sensor
...
Hvis en proxy eller firewall er i brug, skal du sikre dig, at servere kan få adgang til alle Microsoft Defender for Endpoint-tjenestens URL-adresser direkte og uden SSL-skæring. Få mere at vide under [Aktivér adgang til URL-adresser for Defender for Endpoint-tjenesten](configure-proxy-internet.md#enable-access-to-microsoft-defender-for-endpoint-service-urls-in-the-proxy-server). Brug af SSL-skæringspunkt forhindrer systemet i at kommunikere med Defender for Endpoint-tjenesten.
...
4. Følg onboardinginstruktionerne [i Microsoft Defender for Endpoint med Microsoft Defender til skyen](/azure/security-center/security-center-wdatp), og hvis du bruger Azure ARC, skal du følge onboardinginstruktionerne i Aktivering af [Microsoft Defender for Endpoint integration](/azure/security-center/security-center-wdatp#enabling-the-microsoft-defender-for-endpoint-integration).
...
Opret en ny gruppepolitik specifikt til onboardingenheder som f.eks. "Microsoft Defender for Endpoint onboarding".

- Create a Gruppepolitik folder named "c:\windows\CHET"

     :::image type="content" source="images/grppolicyconfig1.png" alt-text="Placeringen af mapperne" lightbox="images/grppolicyconfig1.png":::
...
:::image type="content" source="images/deploymma.png" alt-text="Egenskaberne for Installér-cmd" lightbox="images/deploymma.png":::
...
:::image type="content" source="images/startupprops.png" alt-text="Startegenskaber" lightbox="images/startupprops.png":::
...
Da scriptet har en afslutningsmetode og ikke kan køre igen, hvis  RUNDT ER installeret, kan du også bruge en dagligt planlagt opgave for at opnå det samme resultat. Ligesom en Configuration Manager regler for overholdelse af regler og standarder kontrollerer den dagligt for at sikre, at OVERENSSTEMMELSE er til stede.
...
:::image type="content" source="images/deploymmadowmload.png" alt-text="Egenskaberne for installation af overførsel" lightbox="images/deploymmadowmload.png":::

:::image type="content" source="images/tasksch.png" alt-text="Opgavestyring" lightbox="images/tasksch.png":::
...
Kontrollér, at KBs er til stede, før Windows Server 2008 R2. Denne proces giver dig mulighed for at onboarde alle servere, hvis du ikke har Configuration Manager administrere servere.
