...
description: Få mere at vide om funktionsmådeblokerings- og Microsoft Defender for Endpoint
keywords: Microsoft Defender for Endpoint, Slutpunktsregistrering og -svar blokeret tilstand, blokering af passiv tilstand
...
:::image type="content" source="images/mdatp-next-gen-EDR-behavblockcontain.png" alt-text="Funktionsmådeblokering og -spærring i Microsoft Defender ATP-portalen" lightbox="images/mdatp-next-gen-EDR-behavblockcontain.png":::
...
:::image type="content" source="images/blocked-behav-alert.png" alt-text="Siden Vigtige beskeder med en besked via blokering og inddæmmelse af funktionsmåde" lightbox="images/blocked-behav-alert.png":::
...
Adfærdsbaserede enhedslæringsmodeller i Defender for Endpoint blev afbrudt og stoppet hackerens teknikker på to punkter i angrebskæden:

- Det første beskyttelseslag registrerede udnyttelsesfunktionsmåden. Klassificering af enheder i skyen identificerede korrekt truslerne som og instruerede straks klientenheden i at blokere angrebene.
...
:::image type="content" source="images/behavblockcontain-initialaccessalert.png" alt-text="Besked om startadgang i Microsoft 365 Defender portalen" lightbox="images/behavblockcontain-initialaccessalert.png":::

Dette eksempel viser, hvordan adfærdsbaserede modeller til enhedslæring i skyen tilføjer nye lag af beskyttelse mod angreb, selv efter de er begyndt at køre.
...
:::image type="content" source="images/NTLMalertjuicypotato.png" alt-text="En NTLM-besked for malware med juicy-kartomel" lightbox="images/NTLMalertjuicypotato.png":::
...
:::image type="content" source="images/Artifactblockedjuicypotato.png" alt-text="Artefakt blokeret"  lightbox="images/Artifactblockedjuicypotato.png":::
