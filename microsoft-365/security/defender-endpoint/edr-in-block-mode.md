...
I følgende tabel vises krav til Slutpunktsregistrering og -svar i bloktilstand:
...
### <a name="can-i-specify-exclusions-for-edr-in-block-mode"></a>Kan jeg angive udeladelse for Slutpunktsregistrering og -svar i bloktilstand?

Når du får en falsk positiv, kan du sende filen til analyse på Microsoft Sikkerhedsviden [indsendelseswebstedet](https://www.microsoft.com/en-us/wdsi/filesubmission).

Du kan også definere en udelukkelse for Microsoft Defender Antivirus. Se [Konfigurere og validere udeladelse for Microsoft Defender Antivirus scanninger](configure-exclusions-microsoft-defender-antivirus.md).
...
### <a name="is-edr-in-block-mode-supported-on-windows-server-2016-and-windows-server-2012-r2"></a>Understøttes Slutpunktsregistrering og -svar bloktilstand på Windows Server 2016 og Windows Server 2012 R2?
...
- Windows Server 2022
- Windows Server 2019 
- Windows Server 2016 Windows Server 2012 R2 (med [den nye samlede klientløsning](configure-server-endpoints.md#new-windows-server-2012-r2-and-2016-functionality-in-the-modern-unified-solution-preview))

Med den nye [samlede](configure-server-endpoints.md#new-windows-server-2012-r2-and-2016-functionality-in-the-modern-unified-solution-preview) klientløsning til Windows Server 2016 og Windows Server 2012 R2 kan du køre Slutpunktsregistrering og -svar i bloktilstand i enten passiv tilstand eller aktiv tilstand.
