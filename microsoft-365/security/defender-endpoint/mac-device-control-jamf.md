---
title: Eksempler på politikker for enhedsstyring for SYLF
description: Få mere at vide om, hvordan du bruger politikker for enhedsstyring ved hjælp af eksempler, der kan bruges med SYLTEF.
keywords: microsoft, defender, slutpunkt, Microsoft Defender til Endpoint, mac, enhed, kontrol, usb, flytbart, medie, papir papir papirstop
...
ms.locfileid: "63592644"
---
# <a name="examples-of-device-control-policies-for-jamf"></a>Eksempler på politikker for enhedsstyring for SYLF
...
Dette dokument indeholder eksempler på politikker for enhedsstyring, som du kan tilpasse til din egen organisation. Disse eksempler er gældende, hvis du bruger SYLF til at administrere enheder i virksomheden.

## <a name="restrict-access-to-all-removable-media"></a>Begræns adgangen til alle flytbare medier

Følgende eksempel begrænser adgangen til alle flytbare medier. Bemærk den `none` tilladelse, der er anvendt på det øverste niveau i politikken, hvilket betyder, at alle filhandlinger er forbudt.
