---
title: Opret et program for at få adgang til Microsoft Defender til slutpunkt uden en bruger
ms.reviewer: ''
description: Få mere at vide om, hvordan du designer en webapp for at få programmeringsadgang til Microsoft Defender til slutpunkt uden en bruger.
...
ms.locfileid: "63603093"
---
# <a name="partner-access-through-microsoft-defender-for-endpoint-apis"></a>Partneradgang via Microsoft Defender til endpoint-API'er
...
Microsoft Defender til Slutpunkt fremviser mange af sine data og handlinger via et sæt programmatiske API'er. Disse API'er hjælper dig med at automatisere arbejdsflows og udvikle baseret på Microsoft Defender til slutpunktsfunktioner. API-adgang kræver OAuth2.0-godkendelse. Du kan finde flere oplysninger [under OAuth 2.0-godkendelseskode Flow](/azure/active-directory/develop/active-directory-v2-protocols-oauth-code).
...
Følgende trin hjælper dig med at oprette et Azure AD-program, få et adgangstoken til Microsoft Defender til slutpunkt og validere tokenet.
...
2. Gå til **Azure Active Directory** \> **appregistreringer** \> **Ny registrering**.
   ...
   ![Billede af Microsoft Azure og navigation til programregistrering.](images/atp-azure-new-app2.png)
...
3. I registreringsformularen:
   ...
   ![Billede af Microsoft Azure registreret partnerprogram.](images/atp-api-new-app-partner.png)

4. Giv dit program adgang til Microsoft Defender til Slutpunkt, og tildel det med det minimale sæt tilladelser, der kræves for at fuldføre integrationen.
   ...
   - **Bemærk**! *WindowsDefenderATP* vises ikke på den oprindelige liste. Begynd at skrive navnet i tekstfeltet for at se det.
     ...
     ![tilføj tilladelse.](images/add-permission.png)
...
1. Vælg **Application permissions** \> **Alert.Read.All** > vælg **på Tilføj tilladelser**
   ...
   ![apptilladelser.](images/application-permissions.png)
...
4. Skriv dit program-id ned:
   ...
   ![Billede af oprettet app-id.](images/app-id.png)

5. Føj programmet til din kundes lejer.

   Du skal have din ansøgning godkendt i hver kundelejer, hvor du vil bruge den. Dette skyldes, at dit program interagerer med Microsoft Defender for Endpoint-programmet på vegne af din kunde.
   ...
   ![Billede af samtykke.](images/app-consent-partner.png)
...
- Angiv TENANT_ID Azure-lejer-id'et for den kunde, der vil bruge dit program til at få adgang til Microsoft Defender til slutpunktsprogrammet
...
- I skærmbilledet nedenfor kan du se et afkodet token, der er erhvervet fra et program med flere tilladelser til Microsoft Defender til slutpunkt:
- "tid"-kravet er det lejer-id, som tokenet tilhører.

![Billede af tokenvalidering.](images/webapp-decoded-token.png)
...
- Vælg den API, du vil bruge, hvis du vil have mere at vide, under [Understøttede API'er for Microsoft Defender til slutpunkt](exposed-apis-list.md)
...
- [Få adgang til Microsoft Defender til slutpunkt på vegne af en bruger](exposed-apis-create-app-nativeapp.md)
