---
title: Opret en app for at få adgang til Microsoft Defender til slutpunkt uden en bruger
ms.reviewer: ''
...
ms.locfileid: "63595831"
---
# <a name="create-an-app-to-access-microsoft-defender-for-endpoint-without-a-user"></a>Opret en app for at få adgang til Microsoft Defender til slutpunkt uden en bruger
...
Microsoft Defender til Slutpunkt fremviser mange af sine data og handlinger via et sæt programmatiske API'er. Disse API'er hjælper dig med at automatisere work flows og udvikle baseret på Defender for Endpoint-egenskaber. API-adgang kræver OAuth2.0-godkendelse. Du kan finde flere oplysninger [under OAuth 2.0-godkendelseskode Flow](/azure/active-directory/develop/active-directory-v2-protocols-oauth-code).
...
Denne artikel forklarer, hvordan du opretter et Azure AD-program, får et adgangstoken til Microsoft Defender til slutpunkt og validerer tokenet.
...
4. Hvis du vil aktivere din app til at få adgang til Defender for Endpoint og tildele tilladelsen "Læs alle vigtige beskeder **"**, skal du på din programside vælge **API-tilladelser** \>  \> Tilføj tilladelse API'er, som min organisation **bruger >,** skriv **WindowsDefenderATP**, og vælg **derefter WindowsDefenderATP**.
   ...
   :::image type="content" alt-text="apptilladelse." source="images/application-permissions.png" lightbox="images/application-permissions.png":::
...
5. Vælg **Giv samtykke**.
    ...
    ![Giv tilladelser.](images/grant-consent.png)
...
1. Valider, at du får et "roller"-krav med de ønskede tilladelser.
   ...
   På følgende billede kan du se et afkodet token, der er erhvervet fra en app, med tilladelser til alle Microsoft Defender til Slutpunkts roller:

   :::image type="content" alt-text="Billede af tokenvalidering." source="images/webapp-decoded-token.png" lightbox="images/webapp-decoded-token.png":::
