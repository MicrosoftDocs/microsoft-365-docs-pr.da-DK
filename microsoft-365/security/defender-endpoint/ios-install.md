---
title: Appbaseret installation til Microsoft Defender til Endpoint på iOS
ms.reviewer: ''
description: Beskrivelse af, hvordan du installerer Microsoft Defender til Endpoint på iOS ved hjælp af en app
keywords: microsoft, defender, Microsoft Defender til Endpoint, ios, app, installation, deploy, uninstallation, intune
...
ms.locfileid: "63592646"
---
# <a name="deploy-microsoft-defender-for-endpoint-on-ios"></a>Installer Microsoft Defender til Slutpunkt på iOS
...
I dette emne beskrives udrulning af Defender til Slutpunkt på iOS Intune-firmaportal-tilmeldte enheder. Du kan finde flere oplysninger om registrering af Intune-enheder under [Tilmeld iOS-/iPadOS-enheder i Intune](/mem/intune/enrollment/ios-enroll).
...
> [!NOTE]
> Microsoft Defender til slutpunkt på iOS er tilgængelig i [Apple App-Store](https://aka.ms/mdatpiosappstore).
...
1. I [Microsoft Endpoint Manager Administration skal du](https://go.microsoft.com/fwlink/?linkid=2109431) gå til **AppsiOS** -> **/iPadOSAddiOS** ->  ->  **store app** og klikke på **Vælg**.
    ...
    > ![Billede Microsoft Endpoint Manager Administration1.](images/ios-deploy-1.png)

1. På siden **Tilføj app** skal du klikke **på Søg i Store** og **skrive Microsoft Defender til** slutpunkt i søgefeltet. Klik på Microsoft Defender til slutpunkt i *sektionen med søgeresultater, og* klik på **Vælg**.
...
1. I sektionen **Opgaver skal** du gå til sektionen **Påkrævet** og vælge **Tilføj gruppe**. Du kan derefter vælge den eller de brugergrupper, som du gerne vil målrette Defender for Endpoint på iOS-appen. Klik **på Vælg** og derefter **på Næste**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Billede Microsoft Endpoint Manager Administration2.](images/ios-deploy-2.png)
...
1. På siden med appoplysninger, der vises, skal du i sektionen **Skærm** vælge Installationsstatus for enhed for at bekræfte, at installationen af enheden er fuldført.
    ...
    > [!div class="mx-imgBorder"]
    > ![Billede Microsoft Endpoint Manager Administration3.](images/ios-deploy-3.png)

## <a name="complete-deployment-for-supervised-devices"></a>Komplet udrulning af overvågede enheder

Microsoft Defender til slutpunkt på iOS-appen har særlige muligheder på overvågede iOS/iPadOS-enheder under forudsætning af de øgede administrationsfunktioner, der leveres af platformen på disse typer enheder. Det kan også levere Web Protection **uden at konfigurere et lokalt VPN på enheden**. Dette giver slutbrugerne en problemfri oplevelse, mens de stadig er beskyttet mod phishing og andre webbaserede angreb.

### <a name="configure-supervised-mode-via-intune"></a>Konfigurer tilstanden Overvåget via Intune

Dernæst skal du konfigurere tilstanden, der overvåges for Defender for Endpoint-appen, via en politik for appkonfiguration.
...
1. Angiv *følgende oplysninger på siden Opret* politik for appkonfiguration:
    ...
    - Målrettet app: **Vælg Microsoft Defender til slutpunkt** på listen
...
1. Vælg **Custom VPN** for Connection Type, og i **sektionen Base VPN** skal du skrive følgende:
    - Forbindelsesnavn = Microsoft Defender til slutpunkt
    ...
    ![Et skærmbillede af konfigurationsindstillingerne for VPN-profil](images/ios-deploy-8.png)
...
## <a name="zero-touch-onboarding-of-microsoft-defender-for-endpoint-preview"></a>Onboarding med nul berøring af Microsoft Defender til slutpunkt (prøveversion)
...
1. Vælg **Custom VPN** for Connection Type, og i **sektionen Base VPN** skal du skrive følgende:
    ...
    ![Et skærmbillede af VPN-profilkonfigurationen.](images/ios-deploy-9.png)
...
Når ovenstående konfiguration er udført og synkroniseret med enheden, udføres følgende handlinger på de(e) målrettede iOS-enheder:
    - Microsoft Defender til Slutpunkt installeres og er automatisk onboardet, og enheden kan ses i Defender for Endpoint-portalen.
...
1. Når Defender til Slutpunkt på iOS er blevet installeret på enheden, kan du se appikonet.
    ...
    ![Et skærmbillede af en beskrivelse af en smartphone, der genereres automatisk.](images/41627a709700c324849bf7e13510c516.png)
...
3. Når onboarding er gennemført, vises enheden på listen Enheder i Microsoft 365 Defender portal.
    ...
    > [!div class="mx-imgBorder"]
    > ![Et skærmbillede af en mobiltelefon Beskrivelse genereres automatisk.](images/device-inventory-screen.png)
