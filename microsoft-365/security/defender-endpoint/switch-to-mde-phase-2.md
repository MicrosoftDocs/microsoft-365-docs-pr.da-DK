---
title: Skift til Microsoft Defender for Endpoint – konfiguration
...
## <a name="add-microsoft-defender-for-endpoint-to-the-exclusion-list-for-your-existing-solution"></a>Føj Microsoft Defender for Endpoint til udeladelseslisten for din eksisterende løsning
...
|[Grupper af enheder](/mem/configmgr/core/clients/manage/collections/introduction-to-collections) gør det muligt for sikkerhedsteamet at administrere programmer, installere overholdelsesindstillinger eller installere softwareopdateringer på enhederne i organisationen. <br/><br/> Enhedssamlinger oprettes ved hjælp af [Configuration Manager](/mem/configmgr/).|Følg trinnene i [Opret en samling](/mem/configmgr/core/clients/manage/collections/create-collections#bkmk_create).|
