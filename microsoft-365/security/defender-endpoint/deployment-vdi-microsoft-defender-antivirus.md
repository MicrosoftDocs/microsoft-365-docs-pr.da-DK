---
title: Installationsvejledning til Microsoft Defender Antivirus Virtual Desktop Infrastructure
description: Få mere at vide om, hvordan du installerer Microsoft Defender Antivirus i et virtuelt skrivebordsmiljø for at få den bedste balance mellem beskyttelse og ydeevne.
...
> [!IMPORTANT]
> Selvom VDI kan hostes på Windows Server 2012 eller Windows Server 2016, skal de virtuelle maskiner (VM'er) som minimum køre Windows 10 1607 på grund af øgede beskyttelsesteknologier og funktioner, der ikke er tilgængelige i tidligere versioner af Windows.
...
1. I Gruppepolitik Editor skal du gå til **Administrative skabeloner** \> **Windows-komponenter** \> **Microsoft Defender Antivirus** \> **Scan**.
...
Nogle gange kan Microsoft Defender Antivirus-meddelelser blive sendt til eller bevares på tværs af flere sessioner. Hvis du vil minimere dette problem, kan du låse brugergrænsefladen i Microsoft Defender Antivirus. I følgende procedure beskrives det, hvordan du undertrykker meddelelser med Gruppepolitik.

1. I Gruppepolitik Editor skal du gå til **Windows-komponenter** \> **Microsoft Defender Antivirus** \> **Client Interface**.
...
> - Tryk på tasten med Windows-logoet + A.
...
1. I Gruppepolitik Editor skal du gå til **Windows-komponenter** \> **Microsoft Defender Antivirus** \> **Security Intelligence-Opdateringer**.
...
Denne politik skjuler hele brugergrænsefladen i Microsoft Defender Antivirus fra slutbrugere i din organisation.

## <a name="exclusions"></a>Udeladelser

Udeladelser kan tilføjes, fjernes eller tilpasses, så de passer til dine behov.

Du kan få flere oplysninger under [Konfigurer Microsoft Defender Antivirus-undtagelser på Windows Server](configure-exclusions-microsoft-defender-antivirus.md).
