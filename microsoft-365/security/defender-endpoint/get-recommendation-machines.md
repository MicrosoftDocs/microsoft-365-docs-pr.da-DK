---
title: Vis enheder efter anbefaling
description: Henter en liste over enheder, der er knyttet til sikkerhedsanbefalingen.
keywords: apis, graph api, understøttede API'er, hent, sikkerhedsanbefaling for følsomme enheder, Håndtering af trusler og sikkerhedsrisici, Håndtering af trusler og sikkerhedsrisici API
...
ms.locfileid: "63593443"
---
# <a name="list-devices-by-recommendation"></a>Vis enheder efter anbefaling
...
Henter en liste over enheder, der er knyttet til sikkerhedsanbefalingen.
...
Hvis det lykkes, returnerer denne metode 200 OK med listen over enheder, der er knyttet til sikkerhedsanbefalingen.
