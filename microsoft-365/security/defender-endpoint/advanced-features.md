---
title: Konfigurer avancerede funktioner i Microsoft Defender til Slutpunkt
description: Slå avancerede funktioner som bloker filer til i Microsoft Defender til Slutpunkt.
keywords: avancerede funktioner, indstillinger, bloker fil, automatisk undersøgelse, automatisk løsning, skype, microsoft defender til identitet, Office 365, Azure Information Protection, intune
...
> [!NOTE]
> Livesvar kræver **, at automatiseret** undersøgelse er slået til, før du kan aktivere det i afsnittet avancerede indstillinger på Microsoft Defender for Endpoint-portalen.
...
Denne konfiguration kan bruges til scenarier, hvor lokale SOC-handlinger kun vil begrænse korrelationer for påmindelser til enhedsgrupper, de har adgang til. Hvis du slår denne indstilling til, betragtes en hændelse, der består af beskeder på tværs af enheder, ikke længere som en enkelt hændelse. Den lokale SOC kan derefter handle på hændelsen, fordi de har adgang til en af de involverede enhedsgrupper. Global SOC vil dog se flere forskellige hændelser efter enhedsgruppe i stedet for én hændelse. Vi anbefaler ikke, at du slår denne indstilling til, medmindre du gør det for at se fordelene ved korrelation mellem hændelser i hele organisationen.
...
1. Skift mellem **Til og** **Fra**.
    ...
    :::image type="content" source="../../media/alloworblockfile.png" alt-text="Billede af avancerede indstillinger for funktionen blokfil.":::
...
Hvis du vil bruge denne funktion, skal enhederne køre Windows 10 version 1709 eller nyere eller Windows 11. De skal også have netværksbeskyttelse i blokeringstilstand og version 4.18.1906.3 eller nyere af antimalwareplatformen under [KB 4052623](https://go.microsoft.com/fwlink/?linkid=2099834).
...
Ved at aktivere Skype for Business integration får du mulighed for at kommunikere med brugere ved hjælp Skype for Business, mail eller telefon. Dette kan være praktisk, når du har brug for at kommunikere med brugeren og reducere risici.
...
## <a name="microsoft-defender-for-identity-integration"></a>Integration af Microsoft Defender for Identity

Integration med Microsoft Defender for Identity giver dig mulighed for at pivote direkte ind i et andet Microsoft Identity-sikkerhedsprodukt. Microsoft Defender til identitet øger en undersøgelse med mere viden om en mistænkelig kompromitteret konto og relaterede ressourcer. Ved at aktivere denne funktion kan du forbedre den enhedsbaserede undersøgelsesfunktion ved at pivotere på tværs af netværket fra et identifikationspunkt.
...
Aktivering af denne indstilling videresender Defender til Slutpunkt signalerer til Microsoft Defender til skyapps for at give en dybere indsigt i brugen af skyprogrammer. Videresendte data gemmes og behandles på samme placering som dine Defender til skyapps-data.
...
### <a name="enable-the-microsoft-defender-for-endpoint-integration-from-the-microsoft-defender-for-identity-portal"></a>Aktivér Microsoft Defender for Endpoint-integration fra Microsoft Defender for Identity-portalen

Hvis du vil modtage kontekstafhængig enhedsintegration i Microsoft Defender for Identity, skal du også aktivere funktionen i Microsoft Defender for Identity-portalen.

1. Log på [Microsoft Defender for Identity-portalen med](https://portal.atp.azure.com/) en global administrator- eller sikkerhedsadministratorrolle.
...
Defender til Slutpunkt kan integreres med Microsoft Intune [at](/intune/what-is-intune) [aktivere risikobaseret betinget adgang på enheden](/intune/advanced-threat-protection#enable-windows-defender-atp-in-intune). Når du [har aktiveret denne funktion](configure-conditional-access.md), vil du kunne dele defender for endpoint-enhedsoplysninger med Intune, hvilket forbedrer håndhævelsen af politikken.

> [!IMPORTANT]
> Du skal aktivere integration på både Intune og Defender for Endpoint for at bruge denne funktion. Du kan finde flere oplysninger om specifikke trin [i Konfigurer betinget adgang i Defender til slutpunkt](configure-conditional-access.md).

Denne funktion er kun tilgængelig, hvis du har følgende:
...
Når du aktiverer Intune-integration, opretter Intune automatisk en klassisk politik for Betinget adgang (CA). Denne klassiske nøglecenterpolitik er en forudsætning for at kunne konfigurere statusrapporter til Intune. Den bør ikke slettes.

> [!NOTE]
> Den klassiske nøglecenterpolitik, der oprettes af Intune, er anderledes end moderne [politikker for Betinget adgang](/azure/active-directory/conditional-access/overview/), som bruges til at konfigurere slutpunkter.
