...
|**Bloker forbindelser fra lande, som du ikke handler med**. Opret en Azure AD politik for betinget adgang for at blokere forbindelser, der kommer fra disse lande, og opret effektivt en geofirewall omkring din lejer.||![grønt flueben.](../media/green-check-mark.png)|
...
|Anbefaling|E3|E5|
|---|---|---|
|**Konfigurer Microsoft Defender for Office 365**:<ul><li>Sikre vedhæftede filer</li><li>Sikre links</li><li>Sikre vedhæftede filer i SharePoint, OneDrive og Microsoft Teams</li><li>Repræsentationsbeskyttelse i politikker til bekæmpelse af phishing</li></ul>||![grønt flueben.](../media/green-check-mark.png)|
|**Konfigurer Microsoft Defender for Endpoint funktioner**:<ul><li>Windows Defender Antivirus</li><li>Exploit Protection</li><li>Reduktion af angrebsoverfladen</li><li>Hardwarebaseret isolation</li><li>Styret mappeadgang</li></ul>||![grønt flueben.](../media/green-check-mark.png)|
...
- Deaktiver fjern-PowerShell for alle brugere – Fjern-PowerShell bruges primært af administratorer til at få adgang til tjenester til administrative formål eller programmatisk API-adgang. Vi anbefaler, at du deaktiverer denne indstilling for brugere, der ikke er administratorer, for at undgå rekognoscering, medmindre de har et forretningskrav for at få adgang til den.
...
|**Beskyt data i tredjepartsapps og -tjenester ved hjælp af Defender for Cloud Apps**. Konfigurer Defender for Cloud Apps-politikker for at beskytte følsomme oplysninger på tværs af cloudapps fra tredjepart, f.eks. Salesforce, Box eller Dropbox. Du kan bruge typer af følsomme oplysninger og de følsomhedsmærkater, du har oprettet i Defender for Cloud Apps-politikker, og anvende disse på tværs af dine SaaS-apps. <p> Microsoft Defender for Cloud Apps giver dig mulighed for at gennemtvinge en lang række automatiserede processer. Politikker kan indstilles til at levere kontinuerlige overholdelsesscanninger, juridiske eDiscovery-opgaver, DLP til følsomt indhold, der deles offentligt og meget mere. Defender for Cloud Apps kan overvåge alle filtyper, der er baseret på mere end 20 metadatafiltre (f.eks. adgangsniveau, filtype).||![grønt flueben.](../media/green-check-mark.png)|
...
|Brug **Microsoft Defender for Office 365** værktøjer: <ul><li>Trusselsundersøgelses- og svarfunktioner</li><li>Automatiseret undersøgelse og svar</li></ul>||![grønt flueben.](../media/green-check-mark.png)|
|Brug **Microsoft Defender for Endpoint**: <ul><li>[Slutpunktsregistrering og -svar](/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response)</li><li>Sikker score for automatiseret undersøgelse og afhjælpning</li><li>[Avanceret jagt](/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview)</li></ul>||![grønt flueben.](../media/green-check-mark.png)|
