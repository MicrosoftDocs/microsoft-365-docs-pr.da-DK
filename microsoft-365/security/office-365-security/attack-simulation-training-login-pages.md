---
title: Logonsider i oplæring af simulering af angreb
ms.author: chrisda
author: chrisda
manager: dansimp
audience: ITPro
...
ms.locfileid: "66493952"
---
# <a name="login-pages-in-attack-simulation-training"></a>Logonsider i oplæring af simulering af angreb
...
- **Globale logonsider**: Indeholder de indbyggede logonsider, der ikke kan ændres. Der er fire indbyggede logonsider oversat til 12 sprog:
  - **GitHub-logonside**
  - **LinkedIn-logonside**
  - **Microsoft-logonside**
...
- **Fanen Eksempel** : Få vist logonsiden, som brugerne kan se den. **Side 1** - og **side 2-links** er tilgængelige nederst på siden for brugerdefinerede logonsider med to sider.
...
Du kan oprette brugerdefinerede logonsider på følgende placeringer:
   ...
   > [!NOTE]
   > Ikonet ![Opret ny.](../../media/m365-cc-sc-create-icon.png) **Opret ny** er også tilgængelig under oprettelse af nyttedata og automatisering af nyttedata. Du kan få flere oplysninger i følgende emner:
   >
   > - [Opret brugerdefinerede nyttedata til oplæring i simulering af angreb i Defender for Office 365](attack-simulation-training-payloads.md#create-payloads)
   > - [Opret automatiseringer af nyttedata til oplæring i simulering af angreb](attack-simulation-training-payload-automations.md#create-payload-automations)
   >
