...
- [Spoofing gør det muligt at bruge administratorindsendelse](allow-block-email-spoof.md#use-admin-submission-in-microsoft-365-defender): Opret tilladte spoofed afsenderposter ved hjælp af lejerens tilladelses-/blokliste.

- [Repræsentation gør det muligt at bruge administratorindsendelse](allow-block-email-spoof.md#create-impersonated-sender-entries): Tilføj giver mulighed for repræsenterede afsendere ved hjælp af siden Indsendelser i Microsoft 365 Defender.

- [Få vist konverteret administratorindsendelse fra brugerindsendelse](admin-submission.md#convert-user-reported-messages-from-the-custom-mailbox-into-an-admin-submission): Konfigurer den brugerdefinerede postkasse til at opfange brugerrapporterede meddelelser uden at sende meddelelserne til Microsoft til analyse.

- [Få vist den tilknyttede besked for bruger- og administratorindsendelser](admin-submission.md#view-associated-alert-for-user-and-admin-email-submissions): Få vist den tilsvarende besked for hver bruger rapporterede phishmeddelelse og afsendelse af administratormail. 

- [Konfigurerbar repræsentationsbeskyttelse af brugerdefinerede brugere og domæner og øget omfang i Forudindstillede politikker](https://techcommunity.microsoft.com/t5/microsoft-defender-for-office/configurable-impersonation-protection-and-scope-for-preset/ba-p/3294459):
...
- [Forenkling af karantæneoplevelsen (anden del) i Microsoft 365 Defender til Office 365](https://techcommunity.microsoft.com/t5/microsoft-defender-for-office/simplifying-the-quarantine-experience-part-two/ba-p/3354687): Fremhæver yderligere funktioner for at gøre karantæneoplevelsen endnu nemmere at bruge.
...
- Portalomdirigering starter som standard og omdirigerer brugere fra Security & Compliance til Microsoft 365 Defender <https://security.microsoft.com>. Du kan få mere at vide om dette under: [Omdirigering af konti fra Office 365 Security & Compliance Center til Microsoft 365 Defender](/microsoft-365/security/defender/microsoft-365-security-mdo-redirection)

## <a name="august-2021"></a>August 2021

- [Administration gennemgang af rapporterede meddelelser](admin-review-reported-message.md): Administratorer kan nu sende skabelonmeddelelser tilbage til slutbrugerne, når de har gennemset rapporterede meddelelser. Skabelonerne kan tilpasses til din organisation og også baseret på din administrators dom.
...
- [API til administration af Office 365](/office/office-365-management-api/office-365-management-activity-api-schema#email-message-events): Opdateringer til EmailEvents (RecordType 28) for at tilføje leveringshandling, oprindelige og seneste leveringsplaceringer og opdaterede registreringsoplysninger.
