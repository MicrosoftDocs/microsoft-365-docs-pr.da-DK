...
ms.locfileid: "64477099"
---
# <a name="about-the-microsoft-defender-for-office-365-trial"></a>Om Microsoft Defender for Office 365 prøveversion

> [!IMPORTANT]
> Kom hurtigt i gang med vores [brugervenlige prøvespilbog til Microsoft Defender for Office 365](trial-playbook-defender-for-office-365.md). Denne playbook hjælper dig med at få mest muligt ud af din gratis prøveversion ved at vise dig, hvordan du beskytter din organisation med Microsoft Defender for Office 365.

Microsoft Defender for Office 365 beskytter organisationen mod skadelige trusler, der kan være i mails, links (URL-adresser) og samarbejdsværktøjer. Defender for Office 365 omfatter:
...
- **Rapporter**: Få vist rapporter i realtid for at overvåge Defender for Office 365 ydeevnen i organisationen.
...
En Microsoft Defender for Office 365 prøveversion er en nem måde at afprøve funktionerne i Defender for Office 365 Plan 2 gratis efter blot nogle få klik. Disse funktioner på højt niveau er beskrevet i følgende tabel:
...
|[Rapporter, der Defender for Office 365 funktioner](view-reports-for-mdo.md)|Få vist rapporter, herunder status for trusselsbeskyttelse, URL-trusselsbeskyttelse, mailventetid og meget mere.|
...
Med en prøveversion kan organisationer nemt konfigurere og konfigurere Defender for Office 365 funktioner. Under installationen anvendes politikker, der er eksklusive til Defender for Office 365 (specifikt [Pengeskab](safe-attachments.md) Vedhæftede filer til mails, [Pengeskab Links](safe-links.md) til mails og Microsoft Teams og beskyttelse mod [phishing) ved](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365) hjælp af standardskabelonen til [ forudindstillede sikkerhedspolitikker](preset-security-policies.md).
...
Under konfigurationen af prøveversionen er svarfunktionaliteten, der er eksklusiv for Defender for Office 365 Plan 2 (f.eks. [er AIR](office-365-air.md) og [Threat Explorer](threat-explorer.md) også konfigureret for hele organisationen. Ingen angivelse af politik er påkrævet.

## <a name="licensing"></a>Licensering

Som en del af konfigurationen af prøveversionen Defender for Office 365 licenser automatisk til organisationen. Licenserne er gratis i de første 90 dage.

Licenskortet for prøveversionen viser følgende oplysninger:

:::image type="content" source="../../media/mdo-trial-licensing-card.png" alt-text="Licenskortet i Microsoft Defender for Office 365 prøveversion" lightbox="../../media/mdo-trial-licensing-card.png":::

- **Sektionen Brugstype** :
  - **Prøveversion**: Antallet af prøveabonnementer Defender for Office 365, der er tilgængelige for dig at bruge.
  ...
  - **Betalt**: Antallet af betalte Defender for Office 365 (hvis der er nogen).

- **Afsnittet** Brug: Hvor mange af dine brugere, der er dækket Defender for Office 365 politikker.
  ...
  - **Fuld beskyttelse**: Det samlede antal brugere, der er beskyttet af Defender for Office 365 Plan 2-funktioner (AIR, Threat Explorer, kursus i simulering af angreb osv.).
...
Prøveversionen Defender for Office 365 udrulles gradvist til eksisterende kunder, der opfylder bestemte kriterier, og som ikke har eksisterende Defender for Office 365 Plan 2-licenser (inkluderet i deres abonnement eller som et tilføjelsesprogrammet).

## <a name="terms-and-conditions"></a>Vilkår og betingelser

Du kan finde flere oplysninger [Microsoft Defender for Office 365 vilkår og betingelser & prøveversioner](defender-for-office-365-trial-terms-and-conditions.md).

## <a name="frequently-asked-questions"></a>Ofte stillede spørgsmål

### <a name="q-how-do-i-extend-the-trial"></a>Sp: Hvordan gør jeg du forlænge prøveabonnementet?
...
A: Når prøveperioden udløber, har du adgang til dine prøvedata (data fra funktioner i Defender for Office 365, som du ikke har haft tidligere) i 30 dage. Efter denne periode på 30 dage slettes alle politikker og data, der er Defender for Office 365 den pågældende prøveversion.

### <a name="q-how-many-times-can-i-use-the-defender-for-office-365-trial-in-my-organization"></a>Sp: Hvor mange gange kan jeg bruge den Defender for Office 365 prøveversion i min organisation?

A: Maksimalt 2 gange. Hvis din første prøveversion udløber, skal du vente mindst 30 dage efter udløbsdatoen, før du kan tilmelde dig den Defender for Office 365 prøveversionen igen. Efter dit andet prøveabonnement kan du ikke tilmelde dig et andet prøveabonnement.

## <a name="learn-more-about-defender-for-office-365"></a>Få mere at vide om Defender for Office 365

Defender for Office 365 hjælper organisationer med at sikre deres virksomhed ved at tilbyde en omfattende tavle med egenskaber.

Du kan også få mere at vide Defender for Office 365 i denne [interaktive vejledning](https://aka.ms/MS365D.InteractiveGuide).

:::image type="content" source="../../media/microsoft-defender-for-office-365.png" alt-text="Det Microsoft Defender for Office 365 grundlæggende diagram" lightbox="../../media/microsoft-defender-for-office-365.png":::
...
- [Antiphishing-politikker: Eksklusive indstillinger i Defender for Office 365](set-up-anti-phishing-policies.md#exclusive-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365)
