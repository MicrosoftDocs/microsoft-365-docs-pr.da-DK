---
title: Office 365 sikkerhed, herunder Microsoft Defender til Office 365 og Exchange Online Protection
ms.author: tracyp
author: msfttracyp
manager: dansimp
ms.date: 07/21/2021
...
I denne artikel bliver du introduceret for din nye Microsoft Defender Office 365 egenskaber for sikkerhed i skyen. Uanset om du er en del af et Security Operations Center, er du en sikkerhedsadministrator, der er ny bruger af rummet, eller du vil have en opdatering, så lad os komme i gang.
...
## <a name="what-is-defender-for-office-365-security"></a>Hvad er Defender til Office 365 sikkerhed?
...
1. Microsoft Defender til Office 365 Plan 1 (Defender til Office P1)
1. Microsoft Defender til Office 365 Plan 2 (Defender til Office P2)
...
:::image type="content" source="../../media/tp_GraphicEOPATPP1P2_2.png" alt-text="EOP og Microsoft Defender for Office 365 og deres relationer med hinanden med tjeneste som fremhævelse, herunder en bemærkning til mailgodkendelse.":::
...
Det centrale i Office 365 er EOP-beskyttelse. Microsoft Defender til Office 365 P1 indeholder EOP. Defender til Office 365 P2 indeholder P1 og EOP. Strukturen er kumulativ. Derfor skal du begynde med EOP, når du konfigurerer dette produkt, og arbejde med Defender Office 365.
...
Hvis du har en Office 365 E3, eller nedenfor, har du EOP, men med mulighed for at købe enkeltstående Defender til Office 365 P1 via opgraderingen. Hvis du har Office 365 E5, har du allerede Defender til Office 365 P2.

> [!TIP]
> Hvis dit abonnement ikke er Office 365 E3 eller E5, kan du stadig kontrollere, om du har mulighed for at opgradere til Microsoft Defender Office 365 P1. Hvis du er [interesseret, viser](https://www.microsoft.com/microsoft-365/exchange/advance-threat-protection#coreui-contentrichblock-x07wids) denne webside abonnementer, der er berettiget til Microsoft Defender Office 365 P1-opgraderingen (se slutningen af siden for at se, om der kan udskrives).
...
> [!IMPORTANT]
> Få mere at vide om oplysningerne på [disse sider: Exchange Online Protection](exchange-online-protection-overview.md) og [Defender Office 365](defender-for-office-365.md).

Hvad gør tilføjelse af Microsoft Defender Office 365-planer til en fordel i kun EOP-trusselsadministration kan være svært at se ved første øjekast. For at finde ud af, om en opgraderingssti passer til din organisation, så lad os se på egenskaberne for hvert produkt, når det kommer til:
...
Da disse produkter er kumulative, skal du tilføje disse muligheder, hvis du evaluerer Microsoft Defender Office 365 P1 og beslutter at abonnere på det.

Vinder med **Defender Office 365, Plan 1** (til dato):
<p>

|Prevent/Detect|Undersøg|Svar|
|---|---|---|
|Teknologier omfatter alt i EOP plus:<ul><li>Pengeskab vedhæftede filer</li><li>Pengeskab links<li>Microsoft Defender til Office 365 beskyttelse af arbejdsbelastninger (f.eks. SharePoint Online, Teams, OneDrive for Business)</li><li>Beskyttelse med tid ved klik i mail, Office klienter og Teams</li><li>antiphishing i Defender til Office 365</li><li>Bruger- og domæne efterligningsbeskyttelse</li><li>Beskeder og SIEM-integrations-API til beskeder</li>|<li>SIEM-integrations-API til registreringer</li><li>**Værktøj til registreringer i realtid**</li><li>URL-sporing</li>|<li>Samme</li></ul>

Så Microsoft Defender til Office 365 P1 udvides på ***prevention** _-siden af hus og tilføjer ekstra former for _*_detection_**.

Microsoft Defender til Office 365 P1 tilføjer **også registreringer i** realtid til undersøgelser. Navnet på dette trusselshundrede værktøj står med fed skrift, fordi det er klart, at du har Defender Office 365 P1. Den vises ikke i Defender for Office 365 P2.

Vinder med **Defender Office 365, Plan 2** (til dato):
<p>

|Prevent/Detect|Undersøg|Svar|
|---|---|---|
|Teknologier omfatter alt i EOP og Microsoft Defender til Office 365 P1 samt:<ul><li>Samme</li>|<li>**Threat Explorer**</li><li>Threat Trackers</li><li>Kampagnevisninger</li>|<li>Automatiseret undersøgelse og svar (AIR)</li><li>AIR fra Threat Explorer</li><li>AIR til kompromitterede brugere</li><li>SIEM-integrations-API til automatiserede undersøgelser</li>

Så Microsoft Defender til Office 365 P2 udvides på undersøgelses- og  svarsiden af huset og tilføjer en ny jagtstyrke. Automatisering.

I Microsoft Defender Office 365 P2 kaldes det primære jagtværktøj **Trusselsstifinder** i stedet for registreringer i realtid. Hvis du får vist Threat Explorer, når du navigerer til Microsoft 365 Defender, er du i Microsoft Defender for Office 365 P2.

Gå til denne artikel for at få mere at vide om Microsoft Defender Office 365 P1 **[og](defender-for-office-365.md)** P2.

> [!TIP]
> EOP og Microsoft Defender Office 365 er også anderledes, når det gælder slutbrugere. I EOP og Defender for Office 365 P1 er fokus på *opmærksomhed, og* så omfatter disse to tjenester tilføjelsesprogrammet *Rapportmeddelelse Outlook*, så brugere kan rapportere mails, de finder mistænkelige, til yderligere analyse. <p> I Defender til Office 365 P2 (der indeholder alt i EOP og P1) skifter fokus til yderligere *kurser for slutbrugere*, så Security Operations Center har adgang til et effektivt Trussels-værktøj og de målepunkter, som det leverer til slutbrugeren.

## <a name="microsoft-defender-for-office-365-plan-1-vs-plan-2-cheat-sheet"></a>Microsoft Defender for Office 365 Plan 1 vs. Plan 2 oversigtsark

Denne hurtige reference hjælper dig med at forstå, hvilke muligheder der er med hver Microsoft Defender til Office 365 abonnement. Når det kombineres med din viden om EOP-funktioner, kan det hjælpe beslutningstagere med at afgøre, hvad Microsoft Defender til Office 365 er bedst til deres behov.
...
Se [nyhederne i Microsoft Defender til Office 365 (herunder udvikling af EOP)](whats-new-in-defender-for-office-365.md)
