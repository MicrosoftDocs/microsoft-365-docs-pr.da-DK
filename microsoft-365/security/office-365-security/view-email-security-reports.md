...
- **Repræsentationsdomæne**<sup>\*</sup>: Repræsentation af afsenderdomæner, som du ejer eller har angivet til beskyttelse i [politikker til bekæmpelse af phishing](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365).
- **Repræsentationsbruger**<sup>\*</sup>: Repræsentation af beskyttede afsendere, som du har angivet i [politikker til bekæmpelse af phishing](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365) eller har lært via postkasseintelligens.
- **Repræsentation af postkasseintelligens**<sup>\*</sup>: Repræsentationsregistreringer fra postkasseintelligens i [politikker til bekæmpelse af phishing](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365).
...
- **Dato (UTC)** **Startdato** og **Slutdato**
- **Detection**: Registreringsteknologiværdier som tidligere beskrevet i denne artikel og i [Opdagelsesteknologier](/office/office-365-management-api/office-365-management-activity-api-schema#detection-technologies).
- **Beskyttet af**: **MDO** (Defender for Office 365) eller **EOP**
- **Retning**:
  - **Alle**
  - **Indgående**
