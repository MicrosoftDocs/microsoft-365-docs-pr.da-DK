...
ms.custom: ''
description: Administratorer kan få mere at vide om, hvordan du opretter, redigerer og sletter de avancerede antiphishing-politikker, der er tilgængelige i organisationer med Microsoft Defender Office 365.
ms.technology: mdo
...
ms.locfileid: "63591318"
---
# <a name="configure-anti-phishing-policies-in-microsoft-defender-for-office-365"></a>Konfigurer antiphishing-politikker i Microsoft Defender til Office 365
...
Antiphishing-politikker i [Microsoft Defender for Office 365](defender-for-office-365.md) kan hjælpe med at beskytte din organisation mod ondsindede efterligningsbaserede phishingangreb og andre typer phishingangreb. Du kan finde flere oplysninger om forskellene mellem antiphishing-politikker i Exchange Online Protection (EOP) og politikker for phishing i Microsoft Defender til Office 365 i Beskyttelse mod [phishing](anti-phishing-protection.md).
...
Du kan konfigurere antiphishing-politikker i Defender Office 365 på Microsoft 365 Defender-portalen eller Exchange Online PowerShell.

Du kan finde oplysninger om konfiguration af de mere begrænsede antiphishing-politikker, der er tilgængelige i Exchange Online Protection (dvs. organisationer uden Defender til Office 365) i Konfigurer [antiphishing-politikker i EOP](configure-anti-phishing-policies-eop.md).
...
- Når du opretter en politik, opretter du faktisk en antiphish-regel og den tilknyttede antiphish-politik på samme tid med samme navn til begge.
- Når du ændrer en politik, ændrer indstillinger, der er relateret til navn, prioritet, aktiveret eller deaktiveret, og modtagerens filtre ændrer antiphish-reglen. Alle andre indstillinger ændrer den tilknyttede antiphish-politik.
- Når du fjerner en politik, fjernes antiphish-reglen og den tilknyttede antiphish-politik.
...
Hver Defender for Office 365 organisation har en indbygget antiphishing-politik, der Office 365 AntiPhish Default, der har disse egenskaber:
...
Hvis du vil øge effektiviteten af beskyttelse mod phishing i Defender til Office 365, kan du oprette brugerdefinerede antiphishingpolitikker med mere restriktive indstillinger, der gælder for bestemte brugere eller grupper af brugere.
...
- Du skal have tildelt tilladelser **i Exchange Online,** før du kan udføre procedurerne i denne artikel:
  ...
  - Hvis du vil have skrivebeskyttet adgang til antiphishing-politikker, skal du være medlem af **rollegrupperne Global læser** **eller** Sikkerhedslæser <sup>\*</sup>.
...
- Se vores anbefalede indstillinger for antiphishing-politikker i Defender for Office 365 i Politikken mod [phishing i Defender for Office 365 indstillinger](recommended-settings-for-eop-and-office365.md#anti-phishing-policy-settings-in-microsoft-defender-for-office-365).
...
5. På siden **Phishing-&,** der vises, skal du konfigurere følgende indstillinger:

   - **Grænseværdi for** phishing-mail: Brug skyderen til at vælge en af følgende værdier:
     - **1 – Standard** (Dette er standardværdien).
     - **2 – Aggressive**
     - **3 – mere aggressive**
     - **4 – mest aggressive**

     Få mere at vide under [Avancerede phishingtærskler i antiphishing-politikker i Microsoft Defender Office 365](set-up-anti-phishing-policies.md#advanced-phishing-thresholds-in-anti-phishing-policies-in-microsoft-defender-for-office-365).

   - **Repræsentation**: Disse indstillinger er en betingelse for politikken, der identificerer bestemte afsendere, der skal søges efter (individuelt eller efter domæne) i Fra-adressen for indgående meddelelser. Du kan finde flere oplysninger [under Indstillinger for repræsentation i antiphishing-politikker i Microsoft Defender Office 365](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365).

     > [!NOTE]
     >
     > - I hver antiphishingpolitik kan du angive maksimalt 350 beskyttede brugere (afsendermailadresser). Du kan ikke angive den samme beskyttede bruger i flere politikker.
     ...
     - **Giv brugerne mulighed for at** beskytte: Standardværdien er slået fra (ikke valgt). Hvis du vil aktivere det, skal du markere afkrydsningsfeltet og derefter klikke på linket Administrer **afsendere (nn),** der vises.

       I pop **op-filen Administrer afsendere for repræsentationsbeskyttelse** , der vises, skal du gøre følgende:

       - **Interne afsendere**: Klik på ![Tilføj internt ikon.](../../media/m365-cc-sc-add-internal-icon.png) **Vælg intern**. I pop **op-menuen Tilføj** interne afsendere, der vises, skal du klikke i feltet og vælge en intern bruger på listen. Du kan filtrere listen ved at skrive brugeren og derefter vælge brugeren fra resultaterne. Du kan bruge de fleste identifikatorer (navn, visningsnavn, alias, mailadresse, kontonavn osv.), men det tilsvarende viste navn vises i resultaterne.
       ...
       - **Eksterne afsendere**: Klik på ![Tilføj eksternt ikon.](../../media/m365-cc-sc-create-icon.png) **Vælg ekstern**. I pop **op-dialogboksen** Tilføj eksterne afsendere, der vises, skal du skrive et  vist navn i feltet Tilføj et navn og en mailadresse i feltet Tilføj en **vaild-mail** og derefter klikke på **Tilføj**.

         Gentag dette trin så mange gange, det er nødvendigt. Hvis du vil fjerne en eksisterende værdi, skal du klikke på Fjern ![Ikonet Fjern.](../../media/m365-cc-sc-remove-selection-icon.png) ud for værdien.

         Når du er færdig, skal du klikke på **Tilføj**

       Tilbage i **pop op-filen** Administrer afsendere for efterligning kan du fjerne poster ved at vælge en eller flere poster på listen. Du kan søge efter poster ved hjælp af ikonet ![Søg.](../../media/m365-cc-sc-create-icon.png) **Søgefelt** .

       Når du har valgt mindst én post, vises ![ikonet Fjern markerede brugere.](../../media/m365-cc-sc-remove-selected-users-icon.png) **Ikonet Fjern markerede** brugere vises, som du kan bruge til at fjerne de markerede poster.

       Klik på Udført, når du er **færdig**.

     - **Aktivér beskyttelse af domæner**: Standardværdien er slået fra (ikke valgt). Hvis du vil aktivere den, skal du markere afkrydsningsfeltet og derefter konfigurere en eller begge af følgende indstillinger, der vises:
       - **Medtag de domæner, jeg ejer**: Markér afkrydsningsfeltet for at aktivere denne indstilling. Hvis du vil have vist de domæner, du ejer, skal **du klikke på Vis mine domæner**.
       - **Medtag brugerdefinerede domæner**: For at aktivere denne indstilling skal du markere afkrydsningsfeltet og derefter klikke på linket Administrer **(nn) brugerdefinerede domæne(r),** der vises. I pop **op-menuen Administrer brugerdefinerede domæner for repræsentationsbeskyttelse** skal du klikke på ![ikonet Tilføj domæner.](../../media/m365-cc-sc-create-icon.png) **Tilføj domæner**.

         I pop **op-billedet** Tilføj brugerdefinerede domæner, der vises, skal  du klikke i feltet Domæne, angive en værdi og derefter trykke på Enter eller vælge den værdi, der vises under feltet. Gentag dette trin så mange gange, det er nødvendigt. Hvis du vil fjerne en eksisterende værdi, skal du klikke på Fjern ![ikon.](../../media/m365-cc-sc-remove-selection-icon.png) ud for værdien.

         Når du er færdig, skal du **klikke på Tilføj domæner**

         > [!NOTE]
         > Du kan maksimalt have 50 domæner i alle antiphishing-politikker.

       Tilbage i **pop op-dialogboksen** Administrer brugerdefinerede domæner for repræsentation kan du fjerne poster ved at vælge en eller flere poster på listen. Du kan søge efter poster ved hjælp af ikonet ![Søg.](../../media/m365-cc-sc-create-icon.png) **Søgefelt** .
   ...
   - **Tilføj afsendere** og domæner, der er tillid til: : Angiv undtagelser til beskyttelse mod efterligning for politikken ved at klikke på **Administrer (nn)** afsendere og domæner, der er tillid til. I pop **op-menuen Administrer brugerdefinerede domæner for repræsentationsbeskyttelse** , der vises, skal du konfigurere følgende indstillinger:
      - **Afsendere**: Bekræft **, at fanen** Afsender er markeret, og ![klik på ikonet Tilføj afsendere](../../media/m365-cc-sc-create-icon.png). I pop **op-menuen Tilføj afsendere** , der er tillid til, som vises, skal du angive en mailadresse i feltet og derefter klikke på **Tilføj**. Gentag dette trin så mange gange, det er nødvendigt. Hvis du vil fjerne en eksisterende post, skal du ![klikke på Ikonet](../../media/m365-cc-sc-close-icon.png) Slet for posten.
      ...
      - **Domæner:** Vælg fanen **Domæne,** og klik på ![ikonet Tilføj domæner](../../media/m365-cc-sc-create-icon.png).
        ...
        I pop **op-billedet** Tilføj domæner, der er tillid til, som  vises, skal du klikke i feltet Domæne, angive en værdi og derefter trykke på Enter eller vælge den værdi, der vises under feltet. Gentag dette trin så mange gange, det er nødvendigt. Hvis du vil fjerne en eksisterende værdi, skal du klikke på Fjern ![ikon.](../../media/m365-cc-sc-remove-selection-icon.png) ud for værdien.

        Klik på Tilføj, når du er **færdig**.

     Tilbage i **pop** op-filen Administrer brugerdefinerede domæner for repræsentation kan du fjerne poster fra fanerne **Afsender** og Domæne ved  at vælge en eller flere poster på listen. Du kan søge efter poster ved hjælp af ikonet ![Søg.](../../media/m365-cc-sc-create-icon.png) **Søgefelt** .
     ...
     > [!NOTE]
     > Det maksimale antal afsendere og domæneposter er 1024.

   - **Aktivér postkasseintelligens**: Standardværdien er aktiveret (valgt), og vi anbefaler, at du lader den være aktiveret. Hvis du vil deaktivere den, skal du fjerne markeringen i afkrydsningsfeltet.

     - **Aktivér intelligencebaseret repræsentationsbeskyttelse: Denne** indstilling er kun tilgængelig, hvis **Aktivér postkasseintelligens** er aktiveret (valgt). Denne indstilling gør det muligt for postkasseintelligens at handle på meddelelser, der identificeres som repræsentationsforsøg. Du angiver den handling, der skal ske i **indstillingen Hvis postkasseintelligens** registrerer en efterligning af en bruger på den næste side.

       Vi anbefaler, at du slår denne indstilling til ved at markere afkrydsningsfeltet. Hvis du vil deaktivere denne indstilling, skal du fjerne markeringen i afkrydsningsfeltet.

   - **Spoof**: I dette afsnit skal du bruge afkrydsningsfeltet Aktivér **spoof intelligence** til at slå efterlignet intelligens til eller fra. Standardværdien er valgt (valgt), og vi anbefaler, at du lader den være tændt. Du angiver den handling, der skal ske med meddelelser fra blokerede spoof-afsendere i indstillingen Hvis meddelelse registreres som **efterlignet** på den næste side.
...
6. På siden **Handlinger** , der vises, skal du konfigurere følgende indstillinger:
   ...
   - **Meddelelseshandlinger**: Konfigurer følgende handlinger i dette afsnit:
     - **Hvis meddelelsen registreres som en efterligning** af en bruger: Denne indstilling er kun tilgængelig, hvis du har valgt Gør det muligt for brugere **at beskytte** på den forrige side. Vælg en af følgende handlinger på rullelisten for meddelelser, hvor afsenderen er en af de beskyttede brugere, du angav på den forrige side:
       ...
       - **An karantæne af** meddelelsen: Hvis du vælger denne handling,  vises der et politikfelt under Anvend karantæne, hvor du vælger den karantænepolitik, der gælder for meddelelser, der er sat i karantæne af bruger efterligningsbeskyttelse. Karantænepolitikker definerer, hvad brugerne kan gøre for meddelelser, der er sat i karantæne, og om brugerne modtager beskeder om karantæne. Du kan få mere at vide under [Karantænepolitikker](quarantine-policies.md).

         En tom **værdi for Anvend karantænepolitik** betyder, at standardkarantænepolitikken bruges (DefaultFullAccessPolicy til registrering af bruger efterligning). Når du senere redigerer antiphishing-politikken eller får vist indstillingerne, vises politikkens standardpolitiknavn i karantæne.
  
       - **Levere meddelelsen og føje andre adresser til linjen Bcc**
       - **Slet meddelelsen, før den leveres**

     - **Hvis meddelelsen registreres som et** efterligning af et domæne: Denne indstilling er kun tilgængelig, hvis du  har valgt Aktivér domæner for at beskytte på den forrige side. Vælg en af følgende handlinger på rullelisten for meddelelser, hvor afsenderens mailadresse er på et af de beskyttede domæner, du har angivet på den forrige side:
       - **Anvend ikke nogen handling**
       - **Omdiriger meddelelse til andre mailadresser**
       - **Flyt meddelelsen til modtagernes mapper med uønsket mail**
       - **An karantæne af meddelelsen**: Hvis du vælger denne handling,  vises der et politikfelt under Anvend karantæne, hvor du vælger den karantænepolitik, der gælder for meddelelser, der er sat i karantæne af domæne efterligningsbeskyttelse.

         En tom **værdi for Anvend karantænepolitik** betyder, at standardpolitikken for karantæne bruges (DefaultFullAccessPolicy til registreringer af domæne efterligning). Når du senere redigerer antiphishing-politikken eller får vist indstillingerne, vises politikkens standardpolitiknavn i karantæne.

       - **Levere meddelelsen og føje andre adresser til linjen Bcc**
       - **Slet meddelelsen, før den leveres**

     - **Hvis postkasseintelligens** registrerer en efterligning af en bruger: Denne indstilling er kun tilgængelig, hvis du har valgt Aktivér intelligens **til** repræsentationsbeskyttelse på den forrige side. Vælg en af følgende handlinger på rullelisten for meddelelser, der blev identificeret som efterligningsforsøg af postkassens intelligens:
       - **Anvend ikke nogen handling**
       - **Omdiriger meddelelse til andre mailadresser**
       - **Flyt meddelelsen til modtagernes mapper med uønsket mail**
       - **An karantæne af meddelelsen**: Hvis du vælger denne handling,  vises et anvend karantænepolitikfelt, hvor du vælger den karantænepolitik, der gælder for meddelelser, der er sat i karantæne af postkassens intelligencebeskyttelse. Karantænepolitikker definerer, hvad brugerne kan gøre for meddelelser, der er sat i karantæne, og om brugerne modtager beskeder om karantæne. Du kan få mere at vide under [Karantænepolitikker](quarantine-policies.md).
         ...
         En tom **værdi for Anvend karantænepolitik** betyder, at standardpolitikken for karantæne bruges (DefaultFullAccessPolicy til registrering af postkasseintelligens). Når du senere redigerer antiphishing-politikken eller får vist indstillingerne, vises politikkens standardpolitiknavn i karantæne.
     ...
     - **Hvis meddelelsen registreres som efterlignet**: Denne indstilling er kun tilgængelig, hvis du har valgt **Aktivér efterlignet intelligens** på den forrige side. Vælg en af følgende handlinger på rullelisten for meddelelser fra blokerede spoof-afsendere:
       ...
       - **An karantæne af meddelelsen**: Hvis du vælger denne handling,  vises et anvend karantænepolitikfelt, hvor du vælger den karantænepolitik, der gælder for meddelelser, der er sat i karantæne af efterlignet intelligencebeskyttelse. Karantænepolitikker definerer, hvad brugerne kan gøre for meddelelser, der er sat i karantæne, og om brugerne modtager beskeder om karantæne. Du kan få mere at vide under [Karantænepolitikker](quarantine-policies.md).
         ...
         En tom **værdi for Anvend karantænepolitik** betyder, at standardpolitikken for karantæne bruges (DefaultFullAccessPolicy til oplysninger om spoof-intelligens). Når du senere redigerer antiphishing-politikken eller får vist indstillingerne, vises politikkens standardpolitiknavn i karantæne.

   - **Sikkerhedstip & indikatorer**: Konfigurer følgende indstillinger:
     ...
     - **Vis brugeres sikkerhedstip: Denne indstilling** er kun tilgængelig, hvis du har valgt **Gør det muligt for brugere at beskytte** på den forrige side.
     - **Vis domænepersonation sikkerhedstip**: Denne indstilling er kun tilgængelig, hvis du har valgt **Aktivér domæner for at beskytte** på den forrige side.
     - **Vis bruger efterligning af usædvanlige tegn sikkerhedstip** Denne indstilling er kun tilgængelig, hvis du har valgt  Gør det muligt for brugere  at beskytte eller Aktivere domæner at beskytte på den forrige side.
     - **Vis (?) for** ikke-godkendte afsendere for spoof: Denne indstilling er kun tilgængelig, hvis du har valgt Aktivér **efterlignet** intelligens på den forrige side. Føjer et spørgsmålstegn (?) til afsenderens billede i feltet Fra i Outlook, hvis meddelelsen ikke består SPF- eller DKIM-kontroller, og meddelelsen ikke består  DMARC eller [ikke-sammensat godkendelse](email-validation-and-authentication.md#composite-authentication).
     - **Vis "via"-mærke**: Denne indstilling er kun tilgængelig, hvis du har valgt **Aktivér efterlignet intelligens** på den forrige side. Føjer et via-mærke (chris@contoso.com via fabrikam.com) til Fra-adressen, hvis det er forskelligt fra domænet i DKIM-signaturen eller **MAIL FRA-adressen** . Standardværdien er den (valgt). Hvis du vil deaktivere den, skal du fjerne markeringen i afkrydsningsfeltet.
...
1. I portalen Microsoft 365 Defender skal du gå til  & **politikker** \> for **samarbejde & Politikker** \> \> for trussel mod **phishing** i **sektionen** Politikker.

2. På **siden Antiphishing** vises følgende egenskaber på listen over antiphishing-politikker:
...
2. På siden **Antiphishing** skal du vælge en brugerdefineret politik på listen ved at klikke på navnet på politikken.
...
Som beskrevet tidligere består en antispampolitik af en antiphish-politik og en antiphish-regel.
...
- Politikken er aktiveret (vi bruger ikke parameteren _Aktiveret_ , og standardværdien er `$true`).
...
- Aktiverer beskyttelse af organisationsdomæner for alle accepterede domæner og målrettet domænebeskyttelse til fabrikam.com.
- Angiver Karantæne som handlingen for domæneregistreringer og bruger standardkarantænepolitikken [for meddelelser](quarantine-policies.md) , der er sat i karantæne (vi bruger ikke parameteren _TargetedDomainQuarantineTag_ ).
- Angiver Mai Prototypeto (mfujito@fabrikam.com) som brugeren, der skal beskyttes mod efterligning.
- Angiver Karantæne som handlingen for brugerregistreringer efterligning og bruger standardkarantænepolitikken [for meddelelser](quarantine-policies.md) , der er sat i karantæne (vi bruger ikke parameteren _TargetedUserQuarantineTag_ ).
- Aktiverer postkasseintelligens (_EnableMailboxIntelligence_), gør det [muligt for](quarantine-policies.md) postkassens intelligencebeskyttelse at handle på meddelelser (_EnableMailboxIntelligenceProtection_), angiver Karantæne som handlingen for registrerede meddelelser og bruger standardkarantænepolitikken for meddelelser, der er sat i karantæne (vi bruger ikke _parameteren MailboxIntelligenceQuarantineTag_).
...
Ud over følgende elementer er de samme indstillinger tilgængelige, når du ændrer en antiphish-politik i PowerShell, som når du opretter politikken som beskrevet i Trin 1: Brug PowerShell til at oprette en [antiphish-politiksektion](#step-1-use-powershell-to-create-an-anti-phish-policy) tidligere i denne artikel.
...
Ellers er der ingen yderligere indstillinger tilgængelige, når du ændrer en antiphish-regel i PowerShell. De samme indstillinger er tilgængelige, når du opretter en regel som beskrevet i trin 2: Brug PowerShell til at oprette en [antiphish-regel](#step-2-use-powershell-to-create-an-anti-phish-rule) tidligere i denne artikel.
...
Hvis du vil bekræfte, at du har konfigureret antiphishing-politikker i Defender Office 365, skal du gøre et af følgende:
...
- I Exchange Online PowerShell skal du \<Name\> erstatte med navnet på politikken eller reglen og køre følgende kommando og kontrollere indstillingerne:
