...
| `RegistryValueType` | `string` | Datatype, f.eks. binær eller streng, for registreringsdatabaseværdien, som den registrerede handling blev anvendt på |
...
| `PreviousRegistryKey` | `string` | Den oprindelige registreringsdatabasenøgle for registreringsdatabaseværdien, før den blev ændret |
| `PreviousRegistryValueName` | `string` | Det oprindelige navn på registreringsdatabaseværdien, før den blev ændret |
| `PreviousRegistryValueData` | `string` | Oprindelige data for registreringsdatabaseværdien, før den blev ændret |
