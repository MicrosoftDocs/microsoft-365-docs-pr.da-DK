...
:::image type="content" source="../../media/investigate-incidents/incidents-ss-incident-select.png" alt-text="Eksempel på valg af en hændelse fra markeringskolonnen." lightbox="../../media/investigate-incidents/incidents-ss-incident-select.png":::
...
:::image type="content" source="../../media/investigate-incidents/incidents-ss-incident-side-panel.png" alt-text="Eksempel på oversigtsruden for en hændelse." lightbox="../../media/investigate-incidents/incidents-ss-incident-side-panel.png":::
...
:::image type="content" source="../../media/incidents-overview/incidents-ss-incident-summary.png" alt-text="Eksempel på oversigtssiden for en hændelse i Microsoft 365 Defender-portalen" lightbox="../../media/incidents-overview/incidents-ss-incident-summary.png":::
...
- Kilden til beskederne (Microsoft Defender for Identity, Microsoft Defender til slutpunkt, Microsoft Defender til Office 365, Defender til skyapps og tilføjelsesprogrammet til appstyring).
- Årsagen til, at de er kædet sammen.

Her er et eksempel.

:::image type="content" source="../../media/investigate-incidents/incident-alerts.png" alt-text="Eksempel på en side med beskeder om en hændelse." lightbox="../../media/investigate-incidents/incident-alerts.png":::
...
:::image type="content" source="../../media/investigate-incidents/incident-alert-example.png" alt-text="Eksempel på en side med beskedoplysninger inden for en hændelse." lightbox="../../media/investigate-incidents/incident-alert-example.png":::
...
:::image type="content" source="../../media/investigate-incidents/incident-devices.png" alt-text="Eksempel på en Enhed-side for en hændelse." lightbox="../../media/investigate-incidents/incident-devices.png":::
...
:::image type="content" source="../../media/investigate-incidents/incident-devices-details.png" alt-text="Eksempel på en side med enheder for Defender til slutpunkt." lightbox="../../media/investigate-incidents/incident-devices-details.png":::
...
:::image type="content" source="../../media/investigate-incidents/incident-mailboxes.png" alt-text="Eksempel på en postkasseside for en hændelse." lightbox="../../media/investigate-incidents/incident-mailboxes.png":::

Du kan markere afkrydsningsfeltet for en postkasse for at få vist en liste over aktive beskeder. Vælg postkassenavnet for at få vist flere postkasseoplysninger på Stifinder-siden for Defender Office 365.

## <a name="investigations"></a>Undersøgelser

Fanen **Undersøgelser viser** alle de automatiske [undersøgelser, der udløses](m365d-autoir.md) af beskeder om denne hændelse. Automatiserede undersøgelser vil udføre afhjælpningshandlinger eller vente på godkendelser af handlinger fra en analytiker, afhængigt af hvordan du har konfigureret dine automatiske undersøgelser til at køre i Defender for Endpoint og Defender Office 365.

:::image type="content" source="../../media/investigate-incidents/incident-investigations.png" alt-text="Eksempel på en undersøgelsesside for en hændelse." lightbox="../../media/investigate-incidents/incident-investigations.png":::
...
:::image type="content" source="../../media/investigate-incidents/incident-evidence.png" alt-text="Eksempel på en bevis- og svarside for en hændelse." lightbox="../../media/investigate-incidents/incident-evidence.png":::
...
1. Afspil beskederne og noderne på grafen, når de opstod over tid, for at forstå kronologien af angrebene.
   ...
   :::image type="content" source="../../media/investigate-incidents/incident-graph-play.gif" alt-text="Eksempel på afspilning af beskeder og noder på Graph side":::
...
2. Åbn en enhedsrude, hvor du kan gennemse enhedsdetaljerne og reagere på afhjælpningshandlinger, f.eks. sletning af en fil eller isolere en enhed.
   ...
   :::image type="content" source="../../media/investigate-incidents/incident-graph-entity-pane.png" alt-text="Eksempel på en enhedsrude på Graph side" lightbox="../../media/investigate-incidents/incident-graph-entity-pane.png":::

3. Fremhæv beskederne baseret på den enhed, de er relateret til.
 
   :::image type="content" source="../../media/investigate-incidents/incident-graph-alert.png" alt-text="Eksempel på en fremhævet besked på siden Graph besked" lightbox="../../media/investigate-incidents/incident-graph-alert.png":::
