...
> [!IMPORTANT]
> Før du ansøger, skal du sørge for at diskutere berettigelseskravene for administrerede trusselsjagttjenester for Slutpunktsangrebsmeddelelser med din Microsoft Technical Service-udbyder og dit kontoteam.

Hvis du vil modtage meddelelser om slutpunktsangreb, skal du have Microsoft 365 Defender installeret med de tilmeldte enheder. Send derefter et program via M365-portalen til meddelelser om slutpunktsangreb.
...
Hvis du allerede har Microsoft Defender for Endpoint og Microsoft 365 Defender, kan du ansøge om meddelelser om slutpunktsangreb via din Microsoft 365 Defender portal.  Meddelelser om slutpunktsangreb giver dig særlig indsigt og analyse, der hjælper dig med at identificere de mest kritiske trusler mod din organisation, så du hurtigt kan reagere på dem.
...
5. Når du har modtaget din velkomstmail, begynder du automatisk at modtage meddelelser om slutpunktsangreb.

6. Du kan bekræfte din status ved at gå **til Indstillinger > Slutpunkter > Generelle > Avancerede funktioner**. Når den er godkendt, vil til/fra-knappen **For meddelelse om slutpunktangreb** være synlig og **slået til**.
...
Du kan modtage meddelelser om slutpunktsangreb fra Microsoft-trusselseksperter via følgende medier:
...
- Din indbakke, hvis du vælger at sende meddelelser om slutpunktangreb til dig via mail. Se [Opret en regel for meddelelse via mail](#create-an-email-notification-rule) nedenfor.
...
## <a name="view-endpoint-attack-notifications"></a>Vis meddelelser om slutpunktsangreb
