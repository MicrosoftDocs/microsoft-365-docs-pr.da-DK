...
Denne fase omfatter implementering af både Windows Server Active Directory og DNS til det virtuelle netværk i et hybridscenarie som beskrevet i [Microsoft Azure Architectures for SharePoint 2013](microsoft-azure-architectures-for-sharepoint-2013.md) og som vist i følgende figur.
...
|:-----|:-----|:-----|
|DC1  <br/> |Domænecontroller med Active Directory.  <br/> |To processorer  <br/> Fra 512 MB til 4 GB RAM  <br/> 1 x 127-GB harddisk  <br/> |
|RRAS  <br/> |Server konfigureret med rollen Routing and Remote Access Service (RRAS).  <br/> |To processorer  <br/> 2-8 GB RAM  <br/> 1 x 127-GB harddisk  <br/> |
|FS1  <br/> |Filserver med shares til sikkerhedskopiering og et slutpunkt for DFSR.  <br/> |Fire processorer  <br/> 2-12 GB RAM  <br/> 1 x 127-GB harddisk  <br/> 1 x 1-TB harddisk (SAN)  <br/> 1 x 750 GB harddisk  <br/> |
|SP-WFE1, SP-WFE2  <br/> |Front end-webservere.  <br/> |Fire processorer  <br/> 16 GB RAM  <br/> |
|SP-APP1, SP-APP2, SP-APP3  <br/> |Programservere.  <br/> |Fire processorer  <br/> 2-16 GB RAM  <br/> |
|SP-SQL-HA1, SP-SQL-HA2  <br/> |Databaseservere, konfigureret med SQL Server 2012 AlwaysOn-tilgængelighedsgrupper for at give høj tilgængelighed. Denne konfiguration bruger SP-SQL-HA1 og SP-SQL-HA2 som de primære og sekundære replikaer.  <br/> |Fire processorer  <br/> 2-16 GB RAM  <br/> |
...
|:-----|:-----|:-----|:-----|:-----|
|spDRAD  <br/> |Domænecontroller med Active Directory  <br/> |To processorer  <br/> Fra 512 MB til 4 GB RAM  <br/> 1 x 127-GB harddisk  <br/> |sp-ADservers  <br/> ||
|AZ-SP-FS  <br/> |Filserver med shares til sikkerhedskopier og et slutpunkt til DFSR  <br/> | A5-konfiguration: <br/>  To processorer <br/>  14 GB RAM <br/>  1 x 127-GB harddisk <br/>  1 x 135 GB harddisk <br/>  1 x 127-GB harddisk <br/>  1 x 150 GB harddisk <br/> |sp-databaseservere  <br/> |DATA_SET  <br/> |
|AZ-WFE1, AZ-WFE2  <br/> |Front End Web-servere  <br/> | A5-konfiguration: <br/>  To processorer <br/>  14 GB RAM <br/>  1 x 127-GB harddisk <br/> |sp-webservere  <br/> |WFE_SET  <br/> |
|AZ-APP1, AZ -APP2, AZ-APP3  <br/> |Programservere  <br/> | A5-konfiguration: <br/>  To processorer <br/>  14 GB RAM <br/>  1 x 127-GB harddisk <br/> |sp-applicationservers  <br/> |APP_SET  <br/> |
|AZ-SQL-HA1, AZ-SQL-HA2  <br/> |Databaseservere og primære og sekundære replikaer for AlwaysOn-tilgængelighedsgrupper  <br/> | A5-konfiguration: <br/>  To processorer <br/>  14 GB RAM <br/> |sp-databaseservere  <br/> |DATA_SET  <br/> |
