...
|10|**Tjenesten AutoDetect** bruges i [Exchange Hybrid-scenarier](/exchange/exchange-deployment-assistant) med [hybrid moderne godkendelse med Outlook til iOS og Android](/Exchange/clients/outlook-for-ios-and-android/use-hybrid-modern-auth) <p> `<email_domain>.outlookmobile.com` <br> `<email_domain>.outlookmobile.us` <br> `52.125.128.0/20` <br> `52.127.96.0/23`|Kundens lokale Exchange server på TCP 443|Indgående servertrafik|
|11|**godkendelse af hybride Azure AD Exchange**|*.msappproxy.net|TCP-udgående servertrafik|
