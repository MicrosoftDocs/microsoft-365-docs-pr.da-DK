...
| Problem | Beskrivelse | Løsning |
| ---------------- | ---------------- | ---------------- |
| **Slettet politik vises** | Når en politik for overholdelse af enheder er blevet slettet fra Intune, vil den midlertidigt fortsat være synlig i Fyrtårn. Hvis MSP-teknikere forsøger at foretage en sammenligning af politikker, der omfatter en politik, der er blevet slettet, får teknikeren følgende fejl: "Noget gik galt. Opdater siden, og prøv igen." | Du kan løse fejlen ved at fjerne den slettede politik fra en sammenligning af politikken og kun sammenligne eksisterende politikker. |

## <a name="threat-management"></a>Administration af trusler

| Problem | Beskrivelse | Løsning |
| ---------------- | ---------------- | ---------------- |
| **Trusselsnavn mangler** | Når MSP-teknikere får vist listen over trusler fra siden Trusselsadministration, kan der være nogle trusler, der mangler navnet på truslerne. Dette sker, når den enhed, som trussel blev registreret på, for nylig blev fjernet fra Intune. | Problemet vil blive løst inden for 48 timer. Der kræves ingen yderligere trin. |
...
## <a name="delegated-admin-permissionsdap"></a>Delegerede administratortilladelser (DAP)
...
## <a name="granular-delegated-admin-permissionsgdap"></a>Detaljeret delegeret administratortilladelser (GDAP)
...
| Problem | Beskrivelse | Løsning |
| ---------------- | ---------------- | ---------------- |
| **Forskellige problemer med GDAP-tilladelser på tværs af Lighthouse** | <ul><li>GDAP-sikkerhedsadministratorer kan ikke få vist risikabele brugere, afvise risici eller bekræfte kompromitterede brugere.</li><li>GDAP-sikkerhedslæsere kan ikke få vist risikabele brugere.</li><li>Globale GDAP-administratorer får vist en fejlmeddelelse, når de forsøger at få vist tjenestestilstanden.</li></ul> | Før GDAP's generelle tilgængelighed er den midlertidige løsning at tildele brugeren en global administrator GDAP-rolle eller administratoragent DAP-rolle. Hvis du vil have vejledning i, hvordan du tildeler rollen global administrator GDAP, skal du se Få detaljeret administratortilladelser [til at administrere en kundes tjeneste](/partner-center/gdap-obtain-admin-permissions-to-manage-customer). Hvis du vil have vejledning i, hvordan du tildeler administratoragent-DAP-rollen, [skal du se Tildel roller og tilladelser til brugere](/partner-center/permissions-overview). Du kan finde en liste over handlinger i Fyrtårn, der kræver Azure Active Directory bestemte roller i partnerlejeren, under [Konfigurere Microsoft 365 lighthouseportalsikkerhed](/microsoft-365/lighthouse/m365-lighthouse-configure-portal-security).
