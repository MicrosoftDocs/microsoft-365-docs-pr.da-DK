---
title: Insider-risikoløsninger
description: Få mere at vide om, hvordan du kan minimere risikoen i din organisation med Insider Risk-løsninger Microsoft 365.
...
Insider-risici er en af de største bekymringer for sikkerheds- og overholdelsesmedarbejdere på den moderne arbejdsplads. Branchestudier har vist, at insider-risici ofte er knyttet til bestemte brugerbegivenheder eller -aktiviteter. Det kan være en udfordring at identificere og vanskeligt at beskytte din organisation mod disse risici. Insider-risici omfatter sårbarheder på en række forskellige områder og kan medføre større problemer for organisationen , lige fra tab af intellektuel ejendom til chikane på arbejdspladsen og meget mere. I følgende figur beskrives almindelige insiderrisici:

![Insider-risikotrusler.](../media/ir-solution-threats.png)
...
| ![IP-tyveriikon.](../media/ir-risk-ip-theft.png)| IP-tyveri | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) |  |
| ![Ikon for vold på arbejdspladsen.](../media/ir-risk-workplace-violence.png)| Arbejdsvold | ![Understøttet](../media/check-mark.png) |  |  |  |
| ![Ikon for svindel/tyve.](../media/ir-risk-fraud.png)| Svindel | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) |  |  |
| ![Ikon for overtrædelse af politik.](../media/ir-risk-policy-violations.png)| Overtrædelse af politik | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) |
| ![Insider-handels-/handshake-ikon.](../media/ir-risk-insider-trading.png)| Insider-handel | ![Understøttet](../media/check-mark.png) |  |  |  |
| ![Ikon for interessekonflikter.](../media/ir-risk-conflicts-of-interest.png)| Interessekonflikter | ![Understøttet](../media/check-mark.png) |  | ![Understøttet](../media/check-mark.png) |  |
| ![Ikon for følsomme datalækager/-enheder.](../media/ir-risk-sensitive-data-leaks.png)| Følsomme datalækager | ![Understøttet](../media/check-mark.png) | ![Understøttet](../media/check-mark.png) |  |  |
| ![Ikon for chikane/personer på arbejdspladsen.](../media/ir-risk-workplace-harassment.png)| Chikane på arbejdspladsen | ![Understøttet](../media/check-mark.png) |  |  |  |
...
Insider-risikostyring er tilgængelig i følgende abonnementer:
...
Informationsbarrierer gør det muligt at begrænse kommunikation og samarbejde mellem to interne grupper for at undgå, at der opstår en i konflikt med hinanden i din organisation.

Informationsbarrierer er tilgængelige i følgende abonnementer:
...
Administration af adgang med rettigheder er tilgængelig i følgende abonnementer:
...
For at beskytte din organisation mod insider-risici skal du konfigurere og udrulle følgende Microsoft 365 løsninger:

![Insider risk solution defense-in-depth.](../media/ir-solution-defense-in-depth.png)

1. Konfigurer og opret politikker for [overholdelse af kommunikation](communication-compliance-solution-overview.md).
2. Konfigurer og opret [insider-politikker for risikostyring](insider-risk-management-solution-overview.md).
3. Valgfrit: Konfigurer og opret [politikker for informationsbarrierer](information-barriers-solution-overview.md).
4. Valgfrit: Aktivér og konfigurer [administration af adgangsrettigheder](privileged-access-management-solution-overview.md).

## <a name="illustrations-with-examples"></a>Illustrationer med eksempler

For at hjælpe dig med at planlægge en integreret strategi for implementering af Microsoft 365 insider-risikoegenskaber kan du *downloade* Microsoft 365-oversigtssæt med illustrationer til beskyttelse af oplysninger og overholdelse af regler og standarder. Du kan finde flere oplysninger om egenskaber for insider-risici i illustrationen af arkitekturen på 5-7. Du er velkommen til at tilpasse disse illustrationer til eget brug.
...
Kursus dine administratorer og overholdelsesteamet i det grundlæggende for hver Insider Risk-løsning, kan hjælpe din organisation med hurtigere at komme i gang med dine implementerings- og implementeringsindsatser. 

Microsoft 365 indeholder følgende ressourcer, der kan hjælpe med at informere og oplære disse brugere i organisationen:
