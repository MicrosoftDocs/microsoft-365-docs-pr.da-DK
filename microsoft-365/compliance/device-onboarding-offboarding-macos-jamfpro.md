...
search.appverid:
- MET150
description: Få mere at vide om, hvordan du onboarder og om bord på macOS-enheder i Microsoft Purview-løsninger ved hjælp af JAMF Pro
ms.openlocfilehash: a4f6928098525cf04c2e752b8c6d467800f270da
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: da-DK
ms.lasthandoff: 07/06/2022
ms.locfileid: "66635617"
---
...
1. Opret en ny konfigurationsprofil i JAMF Pro. Se [jamf Pro-administratorvejledningen](https://www.jamf.com/resources/product-documentation/jamf-pro-administrators-guide/). Brug disse værdier:
...
1. På fanen **Program & Brugerdefinerede indstillinger** skal du vælge **Eksterne programmer**, vælge **Tilføj** og vælge **Brugerdefineret skema** for præferencedomænet. Brug denne værdi:
...
1. Opret en JAMF Pro-konfigurationsfil ved hjælp af **com.microsoft.autoupdate2.plist**. Se [jamf Pro-administratorvejledningen](https://www.jamf.com/resources/product-documentation/jamf-pro-administrators-guide/). Brug disse værdier:
...
1. I **Program & brugerdefinerede indstillinger** skal du vælge **Overfør** og **Tilføj**.

1. I **Indstillinger Domæne** skal du angive `com.microsoft.autoupdate2` og derefter vælge **Upload**.
...
1. Opret en JAMF Pro-konfigurationsfil ved hjælp af procedurerne i [vejledning til JAMF Pro-administratorer](https://www.jamf.com/resources/product-documentation/jamf-pro-administrators-guide/). Brug disse værdier:
...
1. Brug filen **accessibility.mobileconfig** , som du har downloadet fra GitHub.
...
1. Fjern programmet (hvis det ikke bruger MDE)
    1. Se JAMF Pro Docs – Pakkeinstallation – [JAMF Pro-administratorer guide](https://www.jamf.com/resources/product-documentation/jamf-pro-administrators-guide/)Jamf Pro Administratorvejledning
