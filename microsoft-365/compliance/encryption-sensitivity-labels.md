...
> [!NOTE]
> Overvej at bruge denne indstilling sammen med [SharePoint og OneDrive integration med Azure AD B2B](/sharepoint/sharepoint-azureb2b-integration-preview), når følsomhedsmærkater er [aktiveret for Office filer i SharePoint og OneDrive](sensitivity-labels-sharepoint-onedrive-files.md).
...
- I Outlook kan en bruger vælge begrænsninger, der svarer til indstillingen [Videresend ikke](/azure/information-protection/configure-usage-rights#do-not-forward-option-for-emails) eller [Kun kryptér](/azure/information-protection/configure-usage-rights#encrypt-only-option-for-emails) for de valgte modtagere.
    ...
    Hvis du vil kontrollere minimumversionerne af Outlook apps, der bruger indbygget mærkning til at understøtte anvendelse af indstillingen Encrypt-Only med en følsomhedsmærkat, skal du bruge [tabellen capabilities for Outlook](sensitivity-labels-office-apps.md#sensitivity-label-capabilities-in-outlook) og rækken **Lad brugere tildele tilladelser: - Krypter kun**.
...
- I Word, PowerPoint og Excel bliver en bruger bedt om at vælge sine egne tilladelser til bestemte brugere, grupper eller organisationer.
    ...
    Hvis du vil kontrollere, hvilke apps der bruger indbygget mærkat, der understøtter denne indstilling, skal du bruge [tabellen med funktioner til Word, Excel og PowerPoint](sensitivity-labels-office-apps.md#sensitivity-label-capabilities-in-word-excel-and-powerpoint) og rækken **Lad brugerne tildele tilladelser: – Spørg brugere**.
...
|Indstilling |Mærkat, der er synlig i Outlook|Mærkat, der er synlig i Word, Excel PowerPoint|
|:-----|:-----|:-----|:-----|
...
Når begge indstillinger er markeret, er etiketten derfor synlig både i Outlook og i Word, Excel og PowerPoint.
...
3. Hvis afkrydsningsfeltet er markeret, skal du fjerne markeringen i afkrydsningsfeltet: **I Word skal du PowerPoint og Excel bede brugerne om at angive tilladelser**.
...
- Medmindre du har [aktiveret samtidig redigering af filer, der er krypteret med følsomhedsmærkater](sensitivity-labels-coauthoring.md), understøttes følgende handlinger for krypterede filer ikke fra Office apps (Windows, Mac, Android og iOS), og brugerne får vist en fejlmeddelelse om, at noget gik galt. Men SharePoint funktionalitet kan bruges som et alternativ:
...
Vi anbefaler, at du bruger [følsomhedsmærkater til Office filer i SharePoint og OneDrive og Office på internettet for](sensitivity-labels-sharepoint-onedrive-files.md) at opnå den bedste samarbejdsoplevelse for filer, der er krypteret af en følsomhedsmærkat.
