...
Kundenøgle kræver to Azure-abonnementer. Som bedste praksis anbefaler Microsoft, at du opretter nye Azure-abonnementer til brug sammen med Customer Key. Azure Key Vault-nøgler kan kun godkendes til programmer i den samme Azure Active Directory-lejer (Microsoft Azure Active Directory). Du skal oprette de nye abonnementer ved hjælp af den samme Azure AD lejer, der bruges sammen med din organisation, hvor DEP'erne tildeles. Det kan f.eks. være at bruge din arbejds- eller skolekonto, der har globale administratorrettigheder i din organisation. Du kan finde detaljerede trin under [Tilmeld dig Azure som en organisation](/azure/active-directory/fundamentals/sign-up-organization).
...
**FastTrack-teamet yder ikke hjælp til kundenøglen. Office 365 bruger blot FastTrack-portalen til at give dig mulighed for at indsende formularen og hjælpe os med at spore de relevante tilbud på Kundenøgle. Når du har indsendt FastTrack-anmodningen, skal du kontakte det tilsvarende onboardingteam for Kundenøgle for at starte onboardingprocessen.**
...
4. Vælg oplysningskortet for det tilbud, der gælder for dig:
   ...
   - **Flere Microsoft 365-arbejdsbelastninger:** Vælg hjælpen **til anmodning om krypteringsnøgle til Microsoft 365** .

   - **Exchange Online og Skype for Business:** Vælg hjælp til anmodning **om krypteringsnøgle til Exchange-tilbud**.

   - **SharePoint Online-, OneDrive- og Teams-filer:** Vælg **hjælpen til anmodning om krypteringsnøgle til SharePoint og OneDrive for Business** tilbud.
...
- Kontakt [m365-ck@service.microsoft.com](mailto:m365-ck@service.microsoft.com) for at aktivere kundenøglen til tildeling af dep'er for at kryptere indhold på tværs af flere Microsoft 365-arbejdsbelastninger (Exchange Online, Teams, Microsoft Purview Information Protection) for alle lejerbrugere.
...
Når du opretter en key vault, skal du vælge en SKU: enten Standard eller Premium. Standard-SKU'en gør det muligt at beskytte Azure Key Vault-nøgler med software – der er ingen HSM-nøglebeskyttelse (Hardware Security Module), og Premium SKU'en gør det muligt at bruge HSM'er til beskyttelse af Key Vault nøgler. Customer Key accepterer key vaults, der bruger en af SKU'erne, selvom Microsoft kraftigt anbefaler, at du kun bruger Premium-SKU'en. Omkostningerne til handlinger med nøgler af begge typer er de samme, så den eneste forskel i omkostningerne er omkostningerne pr. måned for hver HSM-beskyttet nøgle. Se [Key Vault priser for at](https://azure.microsoft.com/pricing/details/key-vault/) få flere oplysninger.
...
For hver Microsoft 365-tjeneste, som du bruger Customer Key til, skal du oprette en key vault i hvert af de to Azure-abonnementer, du har oprettet. Hvis du f.eks. vil gøre det muligt for Kundenøgle at bruge DEP'er til scenarier med Exchange Online, SharePoint Online og scenarier med flere arbejdsbelastninger, skal du oprette tre par key vaults.
...
- **Tilladelser til Microsoft 365-programmer** for hver key vault, du bruger til Kundenøgle, du skal give wrapKey, unwrapKey og få tilladelser til den tilsvarende Microsoft 365 Service Principal.

  Hvis du vil give tilladelse til Microsoft 365 Service Principal, skal du køre Cmdlet'en **Set-AzKeyVaultAccessPolicy** ved hjælp af følgende syntaks:
