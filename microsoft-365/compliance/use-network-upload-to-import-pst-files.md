...
3. Klik på ![Tilføj ikon under fanen **Importér**.](../media/ITPro-EAC-AddIcon.gif) **Nyt importjob**.
   ...
   > [!NOTE]
   > Du skal have tildelt de nødvendige tilladelser for at få adgang til siden **Importér** på overholdelsesportalen for at oprette et importjob. Se afsnittet **Før du begynder for at få** flere oplysninger. 
