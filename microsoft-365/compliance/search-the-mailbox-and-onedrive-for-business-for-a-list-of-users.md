...
5. Angiv følgende oplysninger, når scriptet beder om det. Skriv hver oplysning, og tryk derefter på **Enter**.
    ...
    Scriptet henter URL-adresserne for hvert OneDrive for Business websted og opretter og starter derefter søgningen. Du kan enten køre **Get-ComplianceSearch-cmdlet'en** i Security & Compliance PowerShell for at få vist søgestatistikken og -resultaterne, eller du kan gå til siden **Indholdssøgning** på overholdelsesportalen for at få vist oplysninger om søgningen.
