...
|Bcc|Feltet Bcc i en mail. <sup>1</sup>|`bcc:pilarp@contoso.com` <p> `bcc:pilarp` <p> `bcc:"Pilar Pinilla"`|Alle eksempler returnerer meddelelser med Pilar Pinilla, som er inkluderet i feltet Bcc.|
...
|Fra|Afsenderen af en mail. <sup>1</sup>|`from:pilarp@contoso.com` <p> `from:contoso.com`|Meddelelser, der er sendt af den angivne bruger eller sendt fra et angivet domæne.|
...
|Modtagere|Alle modtagerfelter i en mail. Disse felter er Til, Cc og Bcc.1<sup></sup>|`recipients:garthf@contoso.com` <p> `recipients:contoso.com`|Meddelelser, der er sendt til garthf@contoso.com. I det andet eksempel returneres meddelelser, der er sendt til en hvilken som helst modtager i contoso.com domæne.|
