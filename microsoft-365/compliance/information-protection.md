...
description: Implementer Microsoft Purview Information Protection funktioner, der kan hjælpe dig med at beskytte følsomme oplysninger, uanset hvor de befinder sig eller rejser.
ms.openlocfilehash: 4b221bb0019147d7527ee5b8692af9717204b44f
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: da-DK
ms.lasthandoff: 07/06/2022
ms.locfileid: "66636089"
---
...
Implementer funktioner fra **Microsoft Purview Information Protection** (tidligere Microsoft Information Protection) for at hjælpe dig med at finde, klassificere og beskytte følsomme oplysninger, uanset hvor de bor eller rejser.
...
|[Microsoft Purview-scanner til forebyggelse af datatab i det lokale miljø (prøveversion)](dlp-on-premises-scanner-learn.md)|Udvider DLP-overvågning af filaktiviteter og beskyttende handlinger for disse filer til filshares i det lokale miljø samt SharePoint-mapper og dokumentbiblioteker.|[Kom i gang med Microsoft Purview-scanner til forebyggelse af datatab i det lokale miljø (prøveversion)](dlp-on-premises-scanner-get-started.md)|
