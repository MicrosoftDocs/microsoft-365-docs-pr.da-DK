...
ms.locfileid: "64761103"
---
# <a name="set-up-a-connector-to-archive-servicenow-data"></a>Konfigurer en connector til arkivering af ServiceNow-data

Brug en Veritas-connector i Microsoft 365 Overholdelsescenter til at importere og arkivere data fra ServiceNow-platformen til brugerpostkasser i din Microsoft 365 organisation. Veritas leverer en [ServiceNow-connector](https://globanet.com/servicenow/), der henter elementer fra tredjepartsdatakilden og importerer disse elementer til Microsoft 365. Connectoren konverterer indholdet, f.eks. livemeddelelser, vedhæftede filer og meddelelser fra ServiceNow, til et mailformat og importerer derefter disse elementer til brugerpostkasser i Microsoft 365.

Når ServiceNow-data er gemt i brugerpostkasser, kan du anvende Microsoft 365 funktioner til overholdelse af angivne standarder, f.eks. litigation hold, eDiscovery, opbevaringspolitikker og opbevaringsmærkater. Brug af en ServiceNow-connector til at importere og arkivere data i Microsoft 365 kan hjælpe din organisation med at overholde offentlige og lovgivningsmæssige politikker.
...
3. Den ServiceNow-connector, du opretter i Microsoft 365 Overholdelsescenter opretter forbindelse til Veritas Merge1-webstedet hver dag og overfører ServiceNow-indholdet til en sikker Azure Storage placering i Microsoft-cloudmiljøet.
...
Det første trin er at få adgang til siden **Dataconnectors** i Microsoft 365 Overholdelsescenter og oprette en connector til ServiceNow-data.
...
Når du har oprettet ServiceNow-connectoren, kan du få vist connectorstatussen i Microsoft 365 Overholdelsescenter.
